---
title: "[Solution] Linux: ext4-extent-tree-error — ext4 extent tree corruption"
description: "Fix Linux ext4-extent-tree-error errors. ext4 extent tree corruption with these solutions."
platforms: ["linux"]
severities: ["critical"]
...
# Linux: ext4 Extent Tree Error Error

ext4 extent tree error errors occur when the ext4 filesystem encounters issues with extent tree error operations.
...
[12345.678] EXT4-fs error (device sda1): ext4_extent-tree-error:1234: inode #12345: ...
