---
title: "[Solution] Linux: zfs-import-error — ZFS pool import error"
description: "Fix Linux zfs-import-error errors. ZFS pool import error with these solutions."
platforms: ["linux"]
severities: ["warning"]
...
# Linux: ZFS Import Error Error

ZFS import error errors occur when the ZFS filesystem encounters pool, dataset, or data integrity issues.
...
```bash
sudo zfs get all tank | grep -i "import-error"
```
