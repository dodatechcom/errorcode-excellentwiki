---
title: "[Solution] Linux: zfs-scrub-error — ZFS scrub error"
description: "Fix Linux zfs-scrub-error errors. ZFS scrub error with these solutions."
platforms: ["linux"]
severities: ["warning"]
...
# Linux: ZFS Scrub Error Error

ZFS scrub error errors occur when the ZFS filesystem encounters pool, dataset, or data integrity issues.
...
```bash
sudo zfs get all tank | grep -i "scrub-error"
```
