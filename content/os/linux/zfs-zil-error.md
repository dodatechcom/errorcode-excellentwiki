---
title: "[Solution] Linux: zfs-zil-error — ZFS ZIL (ZFS Intent Log) error"
description: "Fix Linux zfs-zil-error errors. ZFS ZIL (ZFS Intent Log) error with these solutions."
platforms: ["linux"]
severities: ["warning"]
...
# Linux: ZFS Zil Error Error

ZFS zil error errors occur when the ZFS filesystem encounters pool, dataset, or data integrity issues.
...
```bash
sudo zfs get all tank | grep -i "zil-error"
```
