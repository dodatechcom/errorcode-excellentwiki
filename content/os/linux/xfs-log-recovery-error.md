---
title: "[Solution] Linux: xfs-log-recovery-error — XFS log recovery error"
description: "Fix Linux xfs-log-recovery-error errors. XFS log recovery error with these solutions."
platforms: ["linux"]
severities: ["critical"]
...
# Linux: XFS Log Recovery Error Error

XFS log recovery error errors occur when the XFS high-performance journaling filesystem encounters issues.
...
[12345.678] XFS (sda1): Metadata corruption detected at xfs_log-recovery-error
