---
title: "[Solution] Error 0x800ccc22 Windows 11/10 — Network Smtp Rcpt Failed Fixed"
description: "Learn how to fix Windows error 0x800ccc22 (Network Smtp Rcpt Failed) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x800ccc22 Windows 11/10 — Network Smtp Rcpt Failed Fixed

The SMTP server rejected the recipient address during the email sending process. Verify the recipient email address is correct and that the server accepts messages for this recipient.

Despite its technical name, error 0x800ccc22 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x800ccc22 (Network Smtp Rcpt Failed) is a Windows system error that appears in the Network category. The full message usually reads:

> "Error 0x800ccc22: Network Smtp Rcpt Failed."
