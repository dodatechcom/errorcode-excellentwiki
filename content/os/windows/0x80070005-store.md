---
title: "[Solution] Error 0x80070005-store Windows 11/10 — Store Access Denied Fixed"
description: "Learn how to fix Windows error 0x80070005-store (Store Access Denied) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80070005-store Windows 11/10 — Store Access Denied Fixed

Microsoft Store is denied access to a required resource causing downloads and installations to fail. This access denied error requires resetting Store permissions and app registration.

Despite its technical name, error 0x80070005-store typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070005-store (Store Access Denied) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80070005-store: Store Access Denied."
