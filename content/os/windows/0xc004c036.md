---
title: "[Solution] Error 0xc004c036 Windows 11/10 — Activation Product Key Uninstall Failed Fixed"
description: "Learn how to fix Windows error 0xc004c036 (Activation Product Key Uninstall Failed) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0xc004c036 Windows 11/10 — Activation Product Key Uninstall Failed Fixed

The product key could not be uninstalled from the Windows licensing store. This may be because the key is currently in use or the licensing service is not responding to requests.

Despite its technical name, error 0xc004c036 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0xc004c036 (Activation Product Key Uninstall Failed) is a Windows system error that appears in the Activation category. The full message usually reads:

> "Error 0xc004c036: Activation Product Key Uninstall Failed."
