---
title: "[Solution] Error 0x80073d13 Windows 11/10 — Store Package Update Failed Fixed"
description: "Learn how to fix Windows error 0x80073d13 (Store Package Update Failed) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80073d13 Windows 11/10 — Store Package Update Failed Fixed

Microsoft Store could not update an installed app due to a version conflict or package corruption. Uninstall the app completely and reinstall it from the Store to resolve this.

Despite its technical name, error 0x80073d13 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80073d13 (Store Package Update Failed) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80073d13: Store Package Update Failed."
