---
title: "[Solution] Error 0x80244011 Windows 11/10 — Wu E Pt Sus Id Not Found Fixed"
description: "Learn how to fix Windows error 0x80244011 (Wu E Pt Sus Id Not Found) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["system"]
weight: 10
...
# [Solution] Error 0x80244011 Windows 11/10 — Wu E Pt Sus Id Not Found Fixed

The Windows Update server could not find a valid update session identifier. This error typically occurs when the update session has expired or was never properly initialized by the update agent.

Despite its technical name, error 0x80244011 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80244011 (Wu E Pt Sus Id Not Found) is a Windows system error that appears in the Update category. The full message usually reads:

> "Error 0x80244011: Wu E Pt Sus Id Not Found."
