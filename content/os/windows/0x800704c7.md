---
title: "[Solution] Error 0x800704c7 Windows 11/10 — Store Network Error Fixed"
description: "Learn how to fix Windows error 0x800704c7 (Store Network Error) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x800704c7 Windows 11/10 — Store Network Error Fixed

Microsoft Store encountered a network connectivity error preventing downloads. Verify your internet connection, proxy settings, and ensure that the Store is not blocked by firewall rules.

Despite its technical name, error 0x800704c7 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x800704c7 (Store Network Error) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x800704c7: Store Network Error."
