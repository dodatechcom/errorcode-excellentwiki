---
title: "[Solution] Error 0xc004c020 Windows 11/10 — Activation Token Expired Fixed"
description: "Learn how to fix Windows error 0xc004c020 (Activation Token Expired) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0xc004c020 Windows 11/10 — Activation Token Expired Fixed

The activation token has expired and needs to be refreshed with the Microsoft activation servers. Run the activation troubleshooter or use slmgr to request a new activation token.

Despite its technical name, error 0xc004c020 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0xc004c020 (Activation Token Expired) is a Windows system error that appears in the Activation category. The full message usually reads:

> "Error 0xc004c020: Activation Token Expired."
