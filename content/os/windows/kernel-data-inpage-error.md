---
title: "[Solution] Error kernel-data-inpage-error Windows 11/10 — Kernel Data Inpage Error Fixed"
description: "Learn how to fix Windows error kernel-data-inpage-error (Kernel Data Inpage Error) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["kernel"]
weight: 10
...
# [Solution] Error kernel-data-inpage-error Windows 11/10 — Kernel Data Inpage Error Fixed

Windows was unable to read a requested page of kernel data from the paging file or physical memory. This error typically indicates a failing hard drive, corrupted file system, or faulty storage controller.

Despite its technical name, error kernel-data-inpage-error typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error kernel-data-inpage-error (Kernel Data Inpage Error) is a Windows system error that appears in the Modern Bsod category. The full message usually reads:

> "Error kernel-data-inpage-error: Kernel Data Inpage Error."
