---
title: "[Solution] Error 0x80240023 Windows 11/10 — Wu E Legacyserver Fixed"
description: "Learn how to fix Windows error 0x80240023 (Wu E Legacyserver) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["system"]
weight: 10
...
# [Solution] Error 0x80240023 Windows 11/10 — Wu E Legacyserver Fixed

Windows Update attempted to use a legacy update server that is no longer supported for the requested update type. This error indicates the update infrastructure needs to be updated to use current endpoints.

Despite its technical name, error 0x80240023 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80240023 (Wu E Legacyserver) is a Windows system error that appears in the Update category. The full message usually reads:

> "Error 0x80240023: Wu E Legacyserver."
