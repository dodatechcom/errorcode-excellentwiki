---
title: "[Solution] Error 0x80073712 Windows 11/10 — Error Sxs Component Store Corrupt Fixed"
description: "Learn how to fix Windows error 0x80073712 (Error Sxs Component Store Corrupt) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["system"]
weight: 10
...
# [Solution] Error 0x80073712 Windows 11/10 — Error Sxs Component Store Corrupt Fixed

The Windows component store is corrupt preventing Windows Update from servicing or installing updates properly. The component store is essential for Windows Update and system file operations.

Despite its technical name, error 0x80073712 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80073712 (Error Sxs Component Store Corrupt) is a Windows system error that appears in the Update category. The full message usually reads:

> "Error 0x80073712: Error Sxs Component Store Corrupt."
