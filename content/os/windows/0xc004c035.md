---
title: "[Solution] Error 0xc004c035 Windows 11/10 — Activation Notification Failed Fixed"
description: "Learn how to fix Windows error 0xc004c035 (Activation Notification Failed) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0xc004c035 Windows 11/10 — Activation Notification Failed Fixed

Windows activation notification could not be completed due to a system communication error. The system may need to be restarted or the Software Protection service may need to be restarted.

Despite its technical name, error 0xc004c035 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0xc004c035 (Activation Notification Failed) is a Windows system error that appears in the Activation category. The full message usually reads:

> "Error 0xc004c035: Activation Notification Failed."
