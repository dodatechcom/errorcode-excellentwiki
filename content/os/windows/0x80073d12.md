---
title: "[Solution] Error 0x80073d12 Windows 11/10 — Store Cache Corrupted Fixed"
description: "Learn how to fix Windows error 0x80073d12 (Store Cache Corrupted) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80073d12 Windows 11/10 — Store Cache Corrupted Fixed

The Microsoft Store cache has become corrupted preventing apps from downloading or updating properly. Clear the Store cache and re-register the Store app to resolve this issue on Windows 10 and 11.

Despite its technical name, error 0x80073d12 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80073d12 (Store Cache Corrupted) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80073d12: Store Cache Corrupted."
