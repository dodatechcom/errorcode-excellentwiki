---
title: "[Solution] Error 0x80070043 Windows 11/10 — Network Name Not Found Fixed"
description: "Learn how to fix Windows error 0x80070043 (Network Name Not Found) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80070043 Windows 11/10 — Network Name Not Found Fixed

The network name could not be found when Windows attempted to connect to a remote resource. Verify the network path is correct, the target device is online, and network discovery is enabled.

Despite its technical name, error 0x80070043 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070043 (Network Name Not Found) is a Windows system error that appears in the Network category. The full message usually reads:

> "Error 0x80070043: Network Name Not Found."
