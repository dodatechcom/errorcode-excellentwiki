---
title: "[Solution] Error 0x80070422 Windows 11/10 — Store Service Disabled Fixed"
description: "Learn how to fix Windows error 0x80070422 (Store Service Disabled) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80070422 Windows 11/10 — Store Service Disabled Fixed

The Microsoft Store service or related Windows Update service has been disabled. Enable the required services through the Services console to restore Store functionality.

Despite its technical name, error 0x80070422 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070422 (Store Service Disabled) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80070422: Store Service Disabled."
