---
title: "[Solution] Error 0x80070520 Windows 11/10 — Store User Aborted Fixed"
description: "Learn how to fix Windows error 0x80070520 (Store User Aborted) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80070520 Windows 11/10 — Store User Aborted Fixed

The Microsoft Store operation was cancelled or aborted by the user or by a system timeout. Retry the operation and ensure the Store window remains in focus during the download.

Despite its technical name, error 0x80070520 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070520 (Store User Aborted) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80070520: Store User Aborted."
