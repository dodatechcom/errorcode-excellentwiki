---
title: "[Solution] Error 0x80070057 Windows 11/10 — Store Invalid Parameter Fixed"
description: "Learn how to fix Windows error 0x80070057 (Store Invalid Parameter) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80070057 Windows 11/10 — Store Invalid Parameter Fixed

Microsoft Store received an invalid parameter causing the requested operation to fail. Reset the Store cache and ensure your system meets the minimum requirements for the app you are installing.

Despite its technical name, error 0x80070057 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070057 (Store Invalid Parameter) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80070057: Store Invalid Parameter."
