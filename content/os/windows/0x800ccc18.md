---
title: "[Solution] Error 0x800ccc18 Windows 11/10 — Network Smtp Starttls Failed Fixed"
description: "Learn how to fix Windows error 0x800ccc18 (Network Smtp Starttls Failed) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x800ccc18 Windows 11/10 — Network Smtp Starttls Failed Fixed

The email client could not establish a secure TLS connection to the SMTP server. This may be caused by outdated TLS settings or the server not supporting the required encryption protocol.

Despite its technical name, error 0x800ccc18 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x800ccc18 (Network Smtp Starttls Failed) is a Windows system error that appears in the Network category. The full message usually reads:

> "Error 0x800ccc18: Network Smtp Starttls Failed."
