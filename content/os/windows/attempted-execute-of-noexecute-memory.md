---
title: "[Solution] Error attempted-execute-of-noexecute-memory Windows 11/10 — Attempted Execute Of Noexecute Memory Fixed"
description: "Learn how to fix Windows error attempted-execute-of-noexecute-memory (Attempted Execute Of Noexecute Memory) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["kernel"]
weight: 10
...
# [Solution] Error attempted-execute-of-noexecute-memory Windows 11/10 — Attempted Execute Of Noexecute Memory Fixed

Windows detected an attempt to execute code in a memory region marked as non-executable. This error is usually caused by a buffer overflow in a device driver or malware injection.

Despite its technical name, error attempted-execute-of-noexecute-memory typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error attempted-execute-of-noexecute-memory (Attempted Execute Of Noexecute Memory) is a Windows system error that appears in the Modern Bsod category. The full message usually reads:

> "Error attempted-execute-of-noexecute-memory: Attempted Execute Of Noexecute Memory."
