---
title: "[Solution] Error 0x80070d22 Windows 11/10 — Error No Applicable Tasks Fixed"
description: "Learn how to fix Windows error 0x80070d22 (Error No Applicable Tasks) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["system"]
weight: 10
...
# [Solution] Error 0x80070d22 Windows 11/10 — Error No Applicable Tasks Fixed

No applicable tasks were found for the requested Windows Update operation causing the update process to fail. This error indicates that the system cannot identify any actionable update components in the current state.

Despite its technical name, error 0x80070d22 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070d22 (Error No Applicable Tasks) is a Windows system error that appears in the Update category. The full message usually reads:

> "Error 0x80070d22: Error No Applicable Tasks."
