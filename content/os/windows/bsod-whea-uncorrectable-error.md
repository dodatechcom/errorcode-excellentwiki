...
severities: ["critical"]
error_types: ["bsod"]
tags: ["bsod", "blue-screen", "whea", "hardware-error", "cpu", "stop-code"]
weight: 5
---
...
- [BSOD PAGE_FAULT_IN_NONPAGED_AREA]({{< relref "/os/windows/bsod-page-fault-in-nonpaged-area" >}}) — Memory page fault from faulty RAM
