---
title: "[Solution] Error 0x800ccc23 Windows 11/10 — Network Smtp No Recipients Fixed"
description: "Learn how to fix Windows error 0x800ccc23 (Network Smtp No Recipients) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x800ccc23 Windows 11/10 — Network Smtp No Recipients Fixed

No valid recipients were specified in the email message preventing the SMTP server from processing it. Check the To, CC, and BCC fields for valid email addresses before resending.

Despite its technical name, error 0x800ccc23 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x800ccc23 (Network Smtp No Recipients) is a Windows system error that appears in the Network category. The full message usually reads:

> "Error 0x800ccc23: Network Smtp No Recipients."
