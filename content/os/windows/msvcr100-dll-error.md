---
title: "[Solution] Error msvcr100-dll-error Windows 11/10 — Msvcr100 Dll Fixed"
description: "Learn how to fix Windows error msvcr100-dll-error (Msvcr100 Dll) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error msvcr100-dll-error Windows 11/10 — Msvcr100 Dll Fixed

The MSVCR100.dll file is missing or corrupted causing applications built with Visual C++ 2010 to fail. Install the Microsoft Visual C++ 2010 Redistributable package to restore this runtime library.

Despite its technical name, error msvcr100-dll-error typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error msvcr100-dll-error (Msvcr100 Dll) is a Windows system error that appears in the Dll category. The full message usually reads:

> "Error msvcr100-dll-error: Msvcr100 Dll."
...
Most DLL errors related to Msvcr100 Dll are resolved by reinstalling the Visual C++ runtimes:
...
```cmd
regsvr32 /u msvcr100_dll_error.dll
regsvr32 msvcr100_dll_error.dll
```
