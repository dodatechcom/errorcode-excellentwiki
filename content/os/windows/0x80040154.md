---
title: "[Solution] Error 0x80040154 Windows 11/10 — Store Class Not Registered Fixed"
description: "Learn how to fix Windows error 0x80040154 (Store Class Not Registered) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80040154 Windows 11/10 — Store Class Not Registered Fixed

Microsoft Store could not register or load a required component preventing app installations. This error typically indicates that essential Store framework files need to be reinstalled or re-registered.

Despite its technical name, error 0x80040154 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80040154 (Store Class Not Registered) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80040154: Store Class Not Registered."
