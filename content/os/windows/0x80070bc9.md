---
title: "[Solution] Error 0x80070bc9 Windows 11/10 — Service Disabled Fixed"
description: "Learn how to fix Windows error 0x80070bc9 (Service Disabled) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["system"]
weight: 10
...
# [Solution] Error 0x80070bc9 Windows 11/10 — Service Disabled Fixed

The Windows Update related service has been disabled preventing any update checks or installations from running. Group Policy settings or third-party software may have disabled the required Windows Update services.

Despite its technical name, error 0x80070bc9 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80070bc9 (Service Disabled) is a Windows system error that appears in the Update category. The full message usually reads:

> "Error 0x80070bc9: Service Disabled."
