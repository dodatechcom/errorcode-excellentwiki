...
This BSOD affects both Windows 10 and 11 and is almost always related to the graphics driver or GPU hardware. The blue screen message typically names the failing driver file (e.g., `nvlddmkm.sys` for NVIDIA, `atikmpag.sys` for AMD).
