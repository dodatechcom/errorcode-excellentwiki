---
title: "[Solution] Error 0x80073d22 Windows 11/10 — Store Package Repair Failed Fixed"
description: "Learn how to fix Windows error 0x80073d22 (Store Package Repair Failed) on Windows 10 and 11. Follow these proven step-by-step solutions with copyable commands."
platforms: ["windows"]
severities: ["error"]
error_types: ["runtime"]
weight: 10
...
# [Solution] Error 0x80073d22 Windows 11/10 — Store Package Repair Failed Fixed

The Microsoft Store package repair operation failed and could not restore the corrupted app to a working state. Try uninstalling and reinstalling the affected application from the Store.

Despite its technical name, error 0x80073d22 typically points to underlying system issues that can be resolved with built-in Windows tools and systematic troubleshooting.

## Description

Error 0x80073d22 (Store Package Repair Failed) is a Windows system error that appears in the Store category. The full message usually reads:

> "Error 0x80073d22: Store Package Repair Failed."
