---
title: "[Solution] GitLab CI DAST Error"
description: "Fix DAST scanning errors in GitLab CI security pipelines."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI DAST Error

Fix DAST scanning errors in GitLab CI security pipelines. This error occurs when GitLab CI encounters configuration or execution problems.
