---
title: "[Solution] GitLab CI Config Lint Error"
description: "Fix CI configuration linting errors with CI Lint API."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI Config Lint Error

Fix CI configuration linting errors with CI Lint API. This error occurs when GitLab CI encounters configuration or execution problems.
