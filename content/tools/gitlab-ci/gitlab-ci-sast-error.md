---
title: "[Solution] GitLab CI SAST Error"
description: "Resolve SAST scanning errors in GitLab CI."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI SAST Error

Resolve SAST scanning errors in GitLab CI. This error occurs when GitLab CI encounters configuration or execution problems.
