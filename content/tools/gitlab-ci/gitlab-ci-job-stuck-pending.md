---
title: "[Solution] GitLab CI Job Stuck Pending"
description: "Resolve jobs stuck in pending state in GitLab CI."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI Job Stuck Pending

Resolve jobs stuck in pending state in GitLab CI. This error occurs when GitLab CI encounters configuration or execution problems.
