---
title: "[Solution] GitLab CI CI_JOB_TOKEN Scopes"
description: "Fix CI_JOB_TOKEN scope and permission errors."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI CI_JOB_TOKEN Scopes

Fix CI_JOB_TOKEN scope and permission errors. This error occurs when GitLab CI encounters configuration or execution problems.
