---
title: "[Solution] GitLab CI Job Token Scope"
description: "Fix job token scope configuration errors in GitLab CI."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI Job Token Scope

Fix job token scope configuration errors in GitLab CI. This error occurs when GitLab CI encounters configuration or execution problems.
