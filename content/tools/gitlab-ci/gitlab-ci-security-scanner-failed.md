---
title: "[Solution] GitLab CI Security Scanner Failed"
description: "Troubleshoot security scanner failures in GitLab CI."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI Security Scanner Failed

Troubleshoot security scanner failures in GitLab CI. This error occurs when GitLab CI encounters configuration or execution problems.
