---
title: "[Solution] GitLab CI Job Failed Exit Code"
description: "Debug job failures with non-zero exit codes in GitLab CI."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI Job Failed Exit Code

Debug job failures with non-zero exit codes in GitLab CI. This error occurs when GitLab CI encounters configuration or execution problems.
