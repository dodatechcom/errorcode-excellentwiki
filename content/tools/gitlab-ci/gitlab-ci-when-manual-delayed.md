---
title: "[Solution] GitLab CI When Manual Delayed"
description: "Fix when:manual and when:delayed configuration errors."
tools: ["gitlab-ci"]
error-types: ["tool-error"]
severities: ["error"]
---

# GitLab CI When Manual Delayed

Fix when:manual and when:delayed configuration errors. This error occurs when GitLab CI encounters configuration or execution problems.
