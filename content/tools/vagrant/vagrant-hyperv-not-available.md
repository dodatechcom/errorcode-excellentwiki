---
title: "[Solution] Vagrant Hyper-V Not Available"
description: "Resolve Hyper-V provider availability errors."
tools: ["vagrant"]
error-types: ["tool-error"]
severities: ["error"]
---

# Vagrant Hyper-V Not Available

Resolve Hyper-V provider availability errors. This error occurs when Vagrant encounters virtual machine, configuration, or provider problems.
