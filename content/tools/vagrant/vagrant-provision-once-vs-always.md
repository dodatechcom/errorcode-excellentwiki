---
title: "[Solution] Vagrant Provision Once vs Always"
description: "Resolve provision once vs always configuration errors."
tools: ["vagrant"]
error-types: ["tool-error"]
severities: ["error"]
---

# Vagrant Provision Once vs Always

Resolve provision once vs always configuration errors. This error occurs when Vagrant encounters virtual machine, configuration, or provider problems.
