---
title: "[Solution] CircleCI Store Test Results Path"
description: "Fix store_test_results path configuration errors."
tools: ["circleci"]
error-types: ["tool-error"]
severities: ["error"]
---

# CircleCI Store Test Results Path

Fix store_test_results path configuration errors. This error occurs when CircleCI encounters configuration or execution problems.
