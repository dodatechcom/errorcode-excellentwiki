---
title: "[Solution] CircleCI Continuation Orb Error"
description: "Fix continuation orb errors in dynamic config."
tools: ["circleci"]
error-types: ["tool-error"]
severities: ["error"]
---

# CircleCI Continuation Orb Error

Fix continuation orb errors in dynamic config. This error occurs when CircleCI encounters configuration or execution problems.
