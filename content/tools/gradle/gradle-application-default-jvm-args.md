---
title: "[Solution] Gradle Application Default JVM Args"
description: "Resolve application default JVM arguments errors."
tools: ["gradle"]
error-types: ["tool-error"]
severities: ["error"]
---

# Gradle Application Default JVM Args

Resolve application default JVM arguments errors. This error occurs when Gradle encounters build, plugin, or dependency problems.
