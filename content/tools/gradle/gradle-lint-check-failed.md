---
title: "[Solution] Gradle Lint Check Failed"
description: "Fix Android lint check failure errors."
tools: ["gradle"]
error-types: ["tool-error"]
severities: ["error"]
---

# Gradle Lint Check Failed

Fix Android lint check failure errors. This error occurs when Gradle encounters build, plugin, or dependency problems.
