---
title: "[Solution] Gradle Init Script Classpath Error"
description: "Fix init script classpath errors."
tools: ["gradle"]
error-types: ["tool-error"]
severities: ["error"]
---

# Gradle Init Script Classpath Error

Fix init script classpath errors. This error occurs when Gradle encounters build, plugin, or dependency problems.
