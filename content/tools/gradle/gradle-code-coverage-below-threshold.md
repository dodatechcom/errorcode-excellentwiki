---
title: "[Solution] Gradle Code Coverage Below Threshold"
description: "Fix code coverage threshold check failures."
tools: ["gradle"]
error-types: ["tool-error"]
severities: ["error"]
---

# Gradle Code Coverage Below Threshold

Fix code coverage threshold check failures. This error occurs when Gradle encounters build, plugin, or dependency problems.
