---
title: "[Solution] Gradle CompileOnly vs RuntimeOnly Error"
description: "Fix compileOnly vs runtimeOnly scope errors."
tools: ["gradle"]
error-types: ["tool-error"]
severities: ["error"]
---

# Gradle CompileOnly vs RuntimeOnly Error

Fix compileOnly vs runtimeOnly scope errors. This error occurs when Gradle encounters build, plugin, or dependency problems.
