---
title: "[Solution] Gradle bootJar Task Error"
description: "Resolve bootJar task failure errors."
tools: ["gradle"]
error-types: ["tool-error"]
severities: ["error"]
---

# Gradle bootJar Task Error

Resolve bootJar task failure errors. This error occurs when Gradle encounters build, plugin, or dependency problems.
