---
title: "[Solution] SQL Server - quorum lost"
description: "Understand and resolve the SQL Server 'quorum lost' error with causes, T-SQL fixes, and examples."
tools: ["sqlserver"]
...
# SQL Server - quorum lost

The SQL Server `quorum lost` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `quorum lost` error in SQL Server indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `quorum lost` error in SQL Server:
