---
title: "[Solution] SQL Server - automatic failover"
description: "Understand and resolve the SQL Server 'automatic failover' error with causes, T-SQL fixes, and examples."
tools: ["sqlserver"]
...
# SQL Server - automatic failover

The SQL Server `automatic failover` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `automatic failover` error in SQL Server indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `automatic failover` error in SQL Server:
