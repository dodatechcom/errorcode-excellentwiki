---
title: "[Solution] Helm JSON Schema Error"
description: "Fix Helm JSON schema errors. Correct values.schema.json and validate input values."
tools: ["helm"]
...
The `helm` command encountered a **json schema error** issue. This error stops normal operation and must be resolved before continuing with your workflow.
