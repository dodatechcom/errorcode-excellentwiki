---
title: "[Solution] Helm Delete Wait Timeout"
description: "Fix Helm delete wait timeout errors. Force delete stuck resources and increase timeouts."
tools: ["helm"]
...
The `helm` command encountered a **delete wait timeout** issue. This error stops normal operation and must be resolved before continuing with your workflow.
