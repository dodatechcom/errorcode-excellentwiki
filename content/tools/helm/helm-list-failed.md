---
title: "[Solution] Helm List Failed"
description: "Fix Helm list command failures. Query releases across namespaces and filter by status."
tools: ["helm"]
...
The `helm` command encountered a **list failed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
