---
title: "[Solution] Helm Proxy Error"
description: "Fix Helm proxy configuration errors. Configure HTTP_PROXY and HTTPS_PROXY for chart operations."
tools: ["helm"]
...
The `helm` command encountered a **proxy error** issue. This error stops normal operation and must be resolved before continuing with your workflow.
