---
title: "[Solution] DynamoDB - min capacity"
description: "Understand and resolve the DynamoDB 'min capacity' error with causes, AWS CLI and SDK fixes, and examples."
tools: ["dynamodb"]
...
# DynamoDB - min capacity

The DynamoDB `min capacity` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `min capacity` error in DynamoDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `min capacity` error in DynamoDB:
