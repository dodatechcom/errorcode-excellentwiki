---
title: "[Solution] DynamoDB - Cognito identity"
description: "Understand and resolve the DynamoDB 'Cognito identity' error with causes, AWS CLI and SDK fixes, and examples."
tools: ["dynamodb"]
...
# DynamoDB - Cognito identity

The DynamoDB `Cognito identity` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `Cognito identity` error in DynamoDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `Cognito identity` error in DynamoDB:
