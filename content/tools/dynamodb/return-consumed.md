---
title: "[Solution] DynamoDB - return consumed"
description: "Understand and resolve the DynamoDB 'return consumed' error with causes, AWS CLI and SDK fixes, and examples."
tools: ["dynamodb"]
...
# DynamoDB - return consumed

The DynamoDB `return consumed` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `return consumed` error in DynamoDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `return consumed` error in DynamoDB:
