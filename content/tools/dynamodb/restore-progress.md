---
title: "[Solution] DynamoDB - restore progress"
description: "Understand and resolve the DynamoDB 'restore progress' error with causes, AWS CLI and SDK fixes, and examples."
tools: ["dynamodb"]
...
# DynamoDB - restore progress

The DynamoDB `restore progress` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `restore progress` error in DynamoDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `restore progress` error in DynamoDB:
