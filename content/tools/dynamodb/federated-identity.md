---
title: "[Solution] DynamoDB - federated identity"
description: "Understand and resolve the DynamoDB 'federated identity' error with causes, AWS CLI and SDK fixes, and examples."
tools: ["dynamodb"]
...
# DynamoDB - federated identity

The DynamoDB `federated identity` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `federated identity` error in DynamoDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `federated identity` error in DynamoDB:
