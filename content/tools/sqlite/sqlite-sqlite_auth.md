---
title: "SQLite SQLITE_AUTH (Error 23)"
description: "Understand and resolve SQLite SQLITE_AUTH (result code 23): Authorization denied."
tools: ["sqlite"]
...
# SQLite SQLITE_AUTH (Error 23)

SQLite returns **SQLITE_AUTH** (result code 23) when authorization denied. This result code is one of the primary error codes defined in the SQLite C API and is commonly encountered when interacting with SQLite databases from applications.

## Common Causes

- The operation triggered an internal auth condition.
