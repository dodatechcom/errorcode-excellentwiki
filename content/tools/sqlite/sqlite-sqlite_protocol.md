---
title: "SQLite SQLITE_PROTOCOL (Error 15)"
description: "Understand and resolve SQLite SQLITE_PROTOCOL (result code 15): Locking protocol error."
tools: ["sqlite"]
...
# SQLite SQLITE_PROTOCOL (Error 15)

SQLite returns **SQLITE_PROTOCOL** (result code 15) when locking protocol error. This result code is one of the primary error codes defined in the SQLite C API and is commonly encountered when interacting with SQLite databases from applications.

## Common Causes

- The operation triggered an internal protocol condition.
