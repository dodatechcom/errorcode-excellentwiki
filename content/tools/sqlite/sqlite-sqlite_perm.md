---
title: "SQLite SQLITE_PERM (Error 3)"
description: "Understand and resolve SQLite SQLITE_PERM (result code 3): Access permission denied for an operation."
tools: ["sqlite"]
...
# SQLite SQLITE_PERM (Error 3)

SQLite returns **SQLITE_PERM** (result code 3) when access permission denied for an operation. This result code is one of the primary error codes defined in the SQLite C API and is commonly encountered when interacting with SQLite databases from applications.

## Common Causes

- The operation triggered an internal perm condition.
