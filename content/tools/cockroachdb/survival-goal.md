---
title: "[Solution] CockroachDB - survival goal"
description: "Understand and resolve the CockroachDB 'survival goal' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - survival goal

The CockroachDB `survival goal` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `survival goal` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `survival goal` error in CockroachDB:
