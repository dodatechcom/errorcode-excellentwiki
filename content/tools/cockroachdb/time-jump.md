---
title: "[Solution] CockroachDB - time jump"
description: "Understand and resolve the CockroachDB 'time jump' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - time jump

The CockroachDB `time jump` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `time jump` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `time jump` error in CockroachDB:
