---
title: "[Solution] CockroachDB - lease preferences"
description: "Understand and resolve the CockroachDB 'lease preferences' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - lease preferences

The CockroachDB `lease preferences` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `lease preferences` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `lease preferences` error in CockroachDB:
