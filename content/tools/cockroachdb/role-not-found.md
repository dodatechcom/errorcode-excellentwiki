---
title: "[Solution] CockroachDB - role not found"
description: "Understand and resolve the CockroachDB 'role not found' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - role not found

The CockroachDB `role not found` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `role not found` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `role not found` error in CockroachDB:
