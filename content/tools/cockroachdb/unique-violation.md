---
title: "[Solution] CockroachDB - unique violation"
description: "Understand and resolve the CockroachDB 'unique violation' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - unique violation

The CockroachDB `unique violation` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `unique violation` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `unique violation` error in CockroachDB:
