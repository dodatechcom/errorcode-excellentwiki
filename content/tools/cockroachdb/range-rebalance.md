---
title: "[Solution] CockroachDB - range rebalance"
description: "Understand and resolve the CockroachDB 'range rebalance' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - range rebalance

The CockroachDB `range rebalance` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `range rebalance` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `range rebalance` error in CockroachDB:
