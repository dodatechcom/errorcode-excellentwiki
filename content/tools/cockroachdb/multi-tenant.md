---
title: "[Solution] CockroachDB - multi-tenant"
description: "Understand and resolve the CockroachDB 'multi-tenant' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
The CockroachDB `multi-tenant` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `multi-tenant` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `multi-tenant` error in CockroachDB:
