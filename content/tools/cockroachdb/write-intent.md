---
title: "[Solution] CockroachDB - write intent"
description: "Understand and resolve the CockroachDB 'write intent' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - write intent

The CockroachDB `write intent` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `write intent` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `write intent` error in CockroachDB:
