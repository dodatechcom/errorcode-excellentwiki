---
title: "[Solution] CockroachDB - lease transfer"
description: "Understand and resolve the CockroachDB 'lease transfer' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - lease transfer

The CockroachDB `lease transfer` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `lease transfer` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `lease transfer` error in CockroachDB:
