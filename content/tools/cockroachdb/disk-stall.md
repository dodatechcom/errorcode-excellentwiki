---
title: "[Solution] CockroachDB - disk stall"
description: "Understand and resolve the CockroachDB 'disk stall' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - disk stall

The CockroachDB `disk stall` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `disk stall` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `disk stall` error in CockroachDB:
