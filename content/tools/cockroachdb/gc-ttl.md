---
title: "[Solution] CockroachDB - GC TTL"
description: "Understand and resolve the CockroachDB 'GC TTL' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
The CockroachDB `GC TTL` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `GC TTL` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `GC TTL` error in CockroachDB:
