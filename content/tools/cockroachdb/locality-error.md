---
title: "[Solution] CockroachDB - locality error"
description: "Understand and resolve the CockroachDB 'locality error' error with causes, SQL fixes, and examples."
tools: ["cockroachdb"]
...
# CockroachDB - locality error

The CockroachDB `locality error` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `locality error` error in CockroachDB indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `locality error` error in CockroachDB:
