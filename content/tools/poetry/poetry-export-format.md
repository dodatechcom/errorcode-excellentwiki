---
title: "[Solution] Poetry Export Format"
description: "Understand and fix poetry export format errors. Troubleshooting guide with common causes, solutions, and code examples."
tools: ["poetry"]
...
The `poetry` command encountered a Export Format issue. This error stops normal operation and must be resolved before continuing with your workflow.
