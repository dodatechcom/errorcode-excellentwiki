---
title: "[Solution] Poetry Add Package"
description: "Understand and fix poetry add package errors. Troubleshooting guide with common causes, solutions, and code examples."
tools: ["poetry"]
...
The `poetry` command encountered a Add Package issue. This error stops normal operation and must be resolved before continuing with your workflow.
