---
title: "[Solution] Poetry Virtualenv Create"
description: "Understand and fix poetry virtualenv create errors. Troubleshooting guide with common causes, solutions, and code examples."
tools: ["poetry"]
...
The `poetry` command encountered a Virtualenv Create issue. This error stops normal operation and must be resolved before continuing with your workflow.
