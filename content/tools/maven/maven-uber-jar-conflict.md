---
title: "[Solution] Maven Uber JAR Conflict"
description: "Fix class conflicts in shaded uber-jar artifacts."
tools: ["maven"]
error-types: ["tool-error"]
severities: ["error"]
---

# Maven Uber JAR Conflict

Fix class conflicts in shaded uber-jar artifacts. This error occurs when Maven encounters build, dependency, or plugin problems.
