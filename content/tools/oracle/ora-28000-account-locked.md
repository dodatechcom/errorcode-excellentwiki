---
title: "[Solution] Oracle - ORA-28000 account locked"
description: "Understand and resolve the Oracle ORA-28000 account locked error with causes, SQL fixes, and examples."
tools: ["oracle"]
...
# Oracle - ORA-28000 account locked

The Oracle `ORA-28000 account locked` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `ORA-28000 account locked` error in Oracle indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `ORA-28000 account locked` error in Oracle:
