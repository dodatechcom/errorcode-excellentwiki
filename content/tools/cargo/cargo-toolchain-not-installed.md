---
title: "[Solution] Cargo Toolchain Not Installed"
description: "Fix Cargo toolchain not installed errors. Install required Rust toolchains with rustup."
tools: ["cargo"]
...
The `cargo` command encountered a **toolchain not installed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
