---
title: "[Solution] Cargo Dependency Not Found"
description: "Fix Cargo dependency not found errors. Resolve missing crates and configure registry access."
tools: ["cargo"]
...
The `cargo` command encountered a **no matching package** issue. This error stops normal operation and must be resolved before continuing with your workflow.
