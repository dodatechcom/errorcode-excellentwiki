---
title: "[Solution] Cargo Native Library Not Found"
description: "Fix Cargo native library not found errors. Install system dependencies and configure pkg-config."
tools: ["cargo"]
...
The `cargo` command encountered a **native library not found** issue. This error stops normal operation and must be resolved before continuing with your workflow.
