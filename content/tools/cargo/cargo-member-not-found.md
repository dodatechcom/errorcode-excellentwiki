---
title: "[Solution] Cargo Member Not Found"
description: "Fix Cargo workspace member not found errors. Add packages to workspace members list."
tools: ["cargo"]
...
The `cargo` command encountered a **package not found** issue. This error stops normal operation and must be resolved before continuing with your workflow.
