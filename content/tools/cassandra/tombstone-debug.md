---
title: "[Solution] Cassandra - tombstone debug"
description: "Understand and resolve the Cassandra 'tombstone debug' error with causes, CQL fixes, and examples."
tools: ["cassandra"]
...
# Cassandra - tombstone debug

The Cassandra `tombstone debug` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `tombstone debug` error in Cassandra indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `tombstone debug` error in Cassandra:
