---
title: "[Solution] Cassandra - minor compaction"
description: "Understand and resolve the Cassandra 'minor compaction' error with causes, CQL fixes, and examples."
tools: ["cassandra"]
...
# Cassandra - minor compaction

The Cassandra `minor compaction` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `minor compaction` error in Cassandra indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `minor compaction` error in Cassandra:
