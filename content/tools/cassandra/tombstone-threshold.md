---
title: "[Solution] Cassandra - tombstone threshold"
description: "Understand and resolve the Cassandra 'tombstone threshold' error with causes, CQL fixes, and examples."
tools: ["cassandra"]
...
# Cassandra - tombstone threshold

The Cassandra `tombstone threshold` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `tombstone threshold` error in Cassandra indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `tombstone threshold` error in Cassandra:
