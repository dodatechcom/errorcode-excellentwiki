---
title: "[Solution] Cassandra - too many tombstones"
description: "Understand and resolve the Cassandra 'too many tombstones' error with causes, CQL fixes, and examples."
tools: ["cassandra"]
...
# Cassandra - too many tombstones

The Cassandra `too many tombstones` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `too many tombstones` error in Cassandra indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `too many tombstones` error in Cassandra:
