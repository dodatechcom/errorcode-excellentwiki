---
title: "[Solution] Cassandra - major compaction"
description: "Understand and resolve the Cassandra 'major compaction' error with causes, CQL fixes, and examples."
tools: ["cassandra"]
...
# Cassandra - major compaction

The Cassandra `major compaction` error can occur during database operations. This page explains what causes it and how to resolve it.

## What This Error Means

Encountering the `major compaction` error in Cassandra indicates a problem that prevents normal database operations from completing successfully. Identifying the root cause quickly is key to minimizing downtime.
...
A typical occurrence of the `major compaction` error in Cassandra:
