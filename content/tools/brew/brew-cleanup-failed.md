---
title: "[Solution] Brew Cleanup Failed"
description: "Fix Homebrew cleanup failures. Remove old versions and free disk space."
tools: ["brew"]
...
The `brew` command encountered a **Cleanup failed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
