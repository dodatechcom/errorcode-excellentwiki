---
title: "[Solution] Brew Keg Not Linked"
description: "Fix Homebrew keg not linked errors. Link kegs and resolve prefix conflicts."
tools: ["brew"]
...
The `brew` command encountered a **not linked** issue. This error stops normal operation and must be resolved before continuing with your workflow.
