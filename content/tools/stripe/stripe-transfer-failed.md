---
title: "[Solution] Stripe Transfer Failed"
description: "Fix Stripe transfer failures. Move funds between accounts and handle transfer rejections."
tools: ["stripe"]
...
The `stripe` command encountered a **transfer_failed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
