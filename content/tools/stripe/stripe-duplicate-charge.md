---
title: "[Solution] Stripe Duplicate Charge"
description: "Fix Stripe duplicate charge errors. Use idempotency keys to prevent duplicate transactions."
tools: ["stripe"]
...
The Stripe API returned a `duplicate_charge` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
