---
title: "[Solution] Stripe Dispute Won"
description: "Handle Stripe dispute won events. Process dispute outcomes and update order status."
tools: ["stripe"]
...
The Stripe API returned a `dispute_won` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
