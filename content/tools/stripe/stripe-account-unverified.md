---
title: "[Solution] Stripe Account Unverified"
description: "Fix Stripe account unverified errors. Complete account verification and provide required documents."
tools: ["stripe"]
...
The Stripe API returned a `account_unverified` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
