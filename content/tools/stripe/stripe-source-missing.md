---
title: "[Solution] Stripe Source Missing"
description: "Fix Stripe source not found errors. Verify payment sources and handle detached sources."
tools: ["stripe"]
...
The `stripe` command encountered a **source_missing** issue. This error stops normal operation and must be resolved before continuing with your workflow.
