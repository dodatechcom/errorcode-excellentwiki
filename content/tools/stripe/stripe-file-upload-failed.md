---
title: "[Solution] Stripe File Upload Failed"
description: "Fix Stripe file upload errors. Upload identity documents and dispute evidence."
tools: ["stripe"]
...
The `stripe` command encountered a **file_upload_failed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
