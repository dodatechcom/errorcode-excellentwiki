---
title: "[Solution] Stripe Requires Capture"
description: "Understand and fix stripe requires capture errors. Troubleshooting guide with common causes, solutions, and code examples."
tools: ["stripe"]
...
The `stripe` command encountered a Requires Capture issue. This error stops normal operation and must be resolved before continuing with your workflow.
