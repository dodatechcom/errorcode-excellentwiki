---
title: "[Solution] Stripe Intent Capture"
description: "Understand and fix stripe intent capture errors. Troubleshooting guide with common causes, solutions, and code examples."
tools: ["stripe"]
...
The `stripe` command encountered a Intent Capture issue. This error stops normal operation and must be resolved before continuing with your workflow.
