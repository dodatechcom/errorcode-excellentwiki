---
title: "[Solution] Stripe Charge Not Refundable"
description: "Fix Stripe charge not refundable errors. Check charge refund status and handle non-refundable charges."
tools: ["stripe"]
...
The Stripe API returned a `charge_not_refundable` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
