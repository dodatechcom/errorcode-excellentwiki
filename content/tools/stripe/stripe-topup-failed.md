---
title: "[Solution] Stripe Topup Failed"
description: "Fix Stripe topup failures. Add funds to Stripe balance and handle topup rejections."
tools: ["stripe"]
...
The `stripe` command encountered a **topup_failed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
