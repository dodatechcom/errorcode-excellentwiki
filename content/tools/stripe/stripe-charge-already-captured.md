---
title: "[Solution] Stripe Charge Already Captured"
description: "Fix Stripe charge already captured errors. Handle duplicate capture attempts and idempotency."
tools: ["stripe"]
...
The Stripe API returned a `charge_already_captured` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
