---
title: "[Solution] Stripe Refund Exceeds Charge"
description: "Fix Stripe refund exceeds charge errors. Validate refund amounts against original charge."
tools: ["stripe"]
...
The Stripe API returned a `refund_exceeds_charge` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
