---
title: "[Solution] Stripe Statement Descriptor Invalid"
description: "Fix Stripe statement descriptor errors. Configure valid statement descriptors for charges."
tools: ["stripe"]
...
The Stripe API returned a `statement_descriptor_invalid` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
