---
title: "[Solution] Stripe Stolen Card"
description: "Understand and fix stripe stolen card errors. Troubleshooting guide with common causes, solutions, and code examples."
tools: ["stripe"]
...
The `stripe` command encountered a Stolen Card issue. This error stops normal operation and must be resolved before continuing with your workflow.
