---
title: "[Solution] Stripe Source Charge Failed"
description: "Fix Stripe source charge failures. Handle bank transfer and source payment failures."
tools: ["stripe"]
...
The Stripe API returned a `source_charge_failed` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
