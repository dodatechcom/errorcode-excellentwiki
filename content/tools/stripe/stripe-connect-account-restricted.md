---
title: "[Solution] Stripe Connect Account Restricted"
description: "Fix Stripe Connect account restrictions. Complete onboarding and resolve account limitations."
tools: ["stripe"]
...
The Stripe API returned a `connect_account_restricted` error. This error occurs when a payment or API operation fails due to a specific condition that must be addressed.
