---
title: "[Solution] Stripe Person Verification Failed"
description: "Fix Stripe person verification failures. Submit identity documents and resolve verification issues."
tools: ["stripe"]
...
The `stripe` command encountered a **verification_failed** issue. This error stops normal operation and must be resolved before continuing with your workflow.
