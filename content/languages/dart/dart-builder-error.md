---
title: "[Solution] Dart Code Error"
description: "Fix Dart build_runner code generation errors caused by conflicting builders or invalid generated code."
languages: ["dart"]
...
Code generation builder error

## Common Error Messages

1. **Dart error: Build runner failed**
2. **Code generation builder threw exception**
3. **Conflicting builders in build.yaml**
...
### Scenario 1: Type safety violation in Code generation builder error

Type safety violation in Code generation builder error often occurs when developers forget to handle edge cases in their code. For example:
...
### Scenario 2: Null reference during Code generation builder error
...
### Scenario 3: Async error in Code generation builder error
