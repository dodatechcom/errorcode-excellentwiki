...
description: "Fix VBA 'Runtime error 13: Type mismatch' when a value is assigned to an incompatible variable type."
languages: ["vba"]
severities: ["error"]
...
- [Subscript Out of Range](subscript-out-of-range.md) — accessing a nonexistent collection element or array index.
