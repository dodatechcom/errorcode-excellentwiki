---
title: "[Solution] SQL Column Not Found Error Fix"
description: "Fix 'Unknown column X in field list' when a SQL query references a column that does not exist."
languages: ["sql"]
severities: ["error"]
error-types: ["runtime-error"]
tags: ["column-not-found", "unknown-column", "field-list"]
weight: 5
---

# SQL Column Not Found Error Fix
...
- [Syntax Error](syntax-error.md) — malformed SQL syntax before validation.
- [Table Not Found](table-not-found.md) — the table itself does not exist.
- [Type Mismatch](type-mismatch.md) — column exists but the value type is wrong.
