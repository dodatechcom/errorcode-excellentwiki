---
title: "[Solution] EC2 Mixed Instance Policy Error"
description: "Fix Auto Scaling mixed instance policy errors when launching diverse instance types."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Mixed Instance Policy Error

Fix Auto Scaling mixed instance policy errors when launching diverse instance types.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-mixed-instance-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
