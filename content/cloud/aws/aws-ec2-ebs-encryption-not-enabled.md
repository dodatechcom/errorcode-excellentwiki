---
title: "[Solution] EC2 EBS Encryption Not Enabled Error"
description: "Fix EC2 EBS encryption errors when launching instances requiring encrypted volumes."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 EBS Encryption Not Enabled Error

Fix EC2 EBS encryption errors when launching instances requiring encrypted volumes.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-ebs-encryption-not-enabled   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
