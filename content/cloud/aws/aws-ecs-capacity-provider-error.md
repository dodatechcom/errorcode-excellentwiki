---
title: "[Solution] ECS Capacity Provider Error"
description: "Resolve ECS capacity provider errors when managing cluster capacity with Fargate and EC2."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Capacity Provider Error

Resolve ECS capacity provider errors when managing cluster capacity with Fargate and EC2.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-capacity-provider-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
