---
title: "[Solution] ElastiCache Replication Group Error"
description: "Fix ElastiCache replication group errors when Redis replication fails."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ElastiCache Replication Group Error

Fix ElastiCache replication group errors when Redis replication fails.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-elasticache-replication-group-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
