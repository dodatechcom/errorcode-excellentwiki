---
title: "[Solution] Route53 Alias Record Error"
description: "Fix Route53 alias record errors when aliasing to CloudFront ELB or S3 endpoints."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Route53 Alias Record Error

Fix Route53 alias record errors when aliasing to CloudFront ELB or S3 endpoints.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-route53-alias-record-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
