---
title: "[Solution] S3 Object Lock Configuration Error"
description: "Resolve S3 Object Lock errors when trying to protect objects from deletion."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Object Lock Configuration Error

Resolve S3 Object Lock errors when trying to protect objects from deletion.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-object-lock-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
