---
title: "[Solution] ECS Service Connect Error"
description: "Resolve ECS Service Connect errors for service-to-service communication."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Service Connect Error

Resolve ECS Service Connect errors for service-to-service communication.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-service-connect-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
