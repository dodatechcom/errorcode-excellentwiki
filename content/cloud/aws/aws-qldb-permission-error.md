---
title: "[Solution] QLDB Permission Error"
description: "Fix Amazon QLDB permissions errors when accessing ledger resources."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] QLDB Permission Error

Fix Amazon QLDB permissions errors when accessing ledger resources.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-qldb-permission-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws qldb describe-* 2>&1 | head -50
```
