---
title: "[Solution] S3 Cross-Region Replication Error"
description: "Resolve S3 CRR errors when replicating objects between S3 buckets across regions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Cross-Region Replication Error

Resolve S3 CRR errors when replicating objects between S3 buckets across regions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-cross-region-replication-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
