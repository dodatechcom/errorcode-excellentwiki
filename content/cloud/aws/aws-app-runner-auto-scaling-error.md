---
title: "[Solution] App Runner Auto Scaling Configuration Error"
description: "Resolve App Runner auto scaling errors when scaling policies fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] App Runner Auto Scaling Configuration Error

Resolve App Runner auto scaling errors when scaling policies fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-app-runner-auto-scaling-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws app describe-* 2>&1 | head -50
```
