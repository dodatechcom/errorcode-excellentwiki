---
title: "[Solution] IAM User Limit Exceeded Error"
description: "Resolve IAM user limit exceeded errors when creating more users than allowed."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM User Limit Exceeded Error

Resolve IAM user limit exceeded errors when creating more users than allowed.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-user-limit-exceeded   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
