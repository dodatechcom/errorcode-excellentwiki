---
title: "[Solution] IAM Service-Linked Role Creation Error"
description: "Resolve IAM service-linked role errors when AWS services cannot create required roles."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Service-Linked Role Creation Error

Resolve IAM service-linked role errors when AWS services cannot create required roles.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-service-linked-role-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
