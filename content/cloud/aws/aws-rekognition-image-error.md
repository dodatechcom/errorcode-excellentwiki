---
title: "[Solution] Rekognition Image Error"
description: "Fix Amazon Rekognition image analysis errors when detecting objects and labels."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Rekognition Image Error

Fix Amazon Rekognition image analysis errors when detecting objects and labels.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rekognition-image-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws rekognition describe-* 2>&1 | head -50
```
