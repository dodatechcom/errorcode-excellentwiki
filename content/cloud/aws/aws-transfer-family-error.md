---
title: "[Solution] AWS Transfer Family Error"
description: "Resolve AWS Transfer Family errors when setting up SFTP FTPS or FTP endpoints."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] AWS Transfer Family Error

Resolve AWS Transfer Family errors when setting up SFTP FTPS or FTP endpoints.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-transfer-family-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws transfer describe-* 2>&1 | head -50
```
