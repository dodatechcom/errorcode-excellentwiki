---
title: "[Solution] CodeBuild Image Error"
description: "Fix CodeBuild image errors when build environments use invalid or unavailable images."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CodeBuild Image Error

Fix CodeBuild image errors when build environments use invalid or unavailable images.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-codebuild-image-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
