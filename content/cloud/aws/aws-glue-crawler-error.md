---
title: "[Solution] Glue Crawler Error"
description: "Fix AWS Glue crawler errors when discovering data in data stores."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Glue Crawler Error

Fix AWS Glue crawler errors when discovering data in data stores.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-glue-crawler-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
