---
title: "[Solution] CloudFormation Custom Resource Error"
description: "Fix CloudFormation custom resource errors when Lambda-backed resources fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Custom Resource Error

Fix CloudFormation custom resource errors when Lambda-backed resources fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-custom-resource-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
