---
title: "[Solution] CloudFormation Resource Target Resolution Error"
description: "Fix CloudFormation resource targeting errors when Ref or GetAtt functions fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Resource Target Resolution Error

Fix CloudFormation resource targeting errors when Ref or GetAtt functions fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-resource-target-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
