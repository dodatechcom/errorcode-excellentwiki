---
title: "[Solution] VPC Flow Logs Not Working Error"
description: "Fix VPC flow log errors when flow logs are not being created or delivered."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC Flow Logs Not Working Error

Fix VPC flow log errors when flow logs are not being created or delivered.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-flow-log-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
