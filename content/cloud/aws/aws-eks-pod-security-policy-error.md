---
title: "[Solution] EKS Pod Security Policy Error"
description: "Resolve EKS Pod Security Policy errors when pods are denied due to security constraints."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS Pod Security Policy Error

Resolve EKS Pod Security Policy errors when pods are denied due to security constraints.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-pod-security-policy-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
