---
title: "[Solution] S3 Multi-Region Access Point Error"
description: "Fix S3 multi-region access point errors for global data access."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Multi-Region Access Point Error

Fix S3 multi-region access point errors for global data access.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-multi-region-access-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
