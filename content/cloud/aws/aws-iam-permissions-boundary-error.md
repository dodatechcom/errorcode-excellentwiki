---
title: "[Solution] IAM Permissions Boundary Error"
description: "Resolve IAM permissions boundary errors when setting maximum permissions for roles."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Permissions Boundary Error

Resolve IAM permissions boundary errors when setting maximum permissions for roles.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-permissions-boundary-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
