---
title: "[Solution] DocumentDB Cluster Error"
description: "Resolve Amazon DocumentDB cluster errors when managing MongoDB-compatible databases."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] DocumentDB Cluster Error

Resolve Amazon DocumentDB cluster errors when managing MongoDB-compatible databases.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-documentdb-cluster-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws documentdb describe-* 2>&1 | head -50
```
