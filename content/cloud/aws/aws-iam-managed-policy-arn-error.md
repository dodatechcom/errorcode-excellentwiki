---
title: "[Solution] IAM Managed Policy ARN Error"
description: "Resolve IAM managed policy ARN resolution errors when referencing AWS managed policies."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Managed Policy ARN Error

Resolve IAM managed policy ARN resolution errors when referencing AWS managed policies.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-managed-policy-arn-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
