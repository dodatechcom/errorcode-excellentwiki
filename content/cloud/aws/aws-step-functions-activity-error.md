---
title: "[Solution] Step Functions Activity Error"
description: "Resolve Step Functions activity errors when workers fail to poll for tasks."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Step Functions Activity Error

Resolve Step Functions activity errors when workers fail to poll for tasks.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-step-functions-activity-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
