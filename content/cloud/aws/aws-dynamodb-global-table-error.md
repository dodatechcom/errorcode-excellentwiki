---
title: "[Solution] DynamoDB Global Table Error"
description: "Fix DynamoDB global table replication errors across multiple regions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] DynamoDB Global Table Error

Fix DynamoDB global table replication errors across multiple regions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-dynamodb-global-table-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
