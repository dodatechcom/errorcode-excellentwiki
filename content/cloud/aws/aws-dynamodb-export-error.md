---
title: "[Solution] DynamoDB Export to S3 Error"
description: "Resolve DynamoDB export errors when exporting table data to S3."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] DynamoDB Export to S3 Error

Resolve DynamoDB export errors when exporting table data to S3.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-dynamodb-export-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
