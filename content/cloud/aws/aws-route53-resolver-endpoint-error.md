---
title: "[Solution] Route53 Resolver Endpoint Error"
description: "Resolve Route53 Resolver endpoint errors for hybrid DNS between VPC and on-premises."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Route53 Resolver Endpoint Error

Resolve Route53 Resolver endpoint errors for hybrid DNS between VPC and on-premises.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-route53-resolver-endpoint-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
