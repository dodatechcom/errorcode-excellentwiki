---
title: "[Solution] Step Functions Map State Error"
description: "Fix Step Functions Map state errors when iterating over collections in workflows."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Step Functions Map State Error

Fix Step Functions Map state errors when iterating over collections in workflows.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-step-functions-map-state-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
