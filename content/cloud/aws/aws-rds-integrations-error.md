---
title: "[Solution] RDS Data API Integration Error"
description: "Fix RDS Data API errors when accessing Aurora Serverless databases."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] RDS Data API Integration Error

Fix RDS Data API errors when accessing Aurora Serverless databases.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rds-integrations-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
