---
title: "[Solution] RDS Global Database Error"
description: "Resolve RDS Aurora Global Database errors when replicating across regions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] RDS Global Database Error

Resolve RDS Aurora Global Database errors when replicating across regions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rds-global-database-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
