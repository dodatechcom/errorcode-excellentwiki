---
title: "[Solution] S3 Inventory Configuration Error"
description: "Fix S3 inventory errors when generating reports of objects in buckets."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Inventory Configuration Error

Fix S3 inventory errors when generating reports of objects in buckets.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-inventory-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
