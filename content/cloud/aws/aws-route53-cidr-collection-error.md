---
title: "[Solution] Route53 CIDR Collection Error"
description: "Resolve Route53 CIDR collection errors for IP-based geolocation routing."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Route53 CIDR Collection Error

Resolve Route53 CIDR collection errors for IP-based geolocation routing.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-route53-cidr-collection-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
