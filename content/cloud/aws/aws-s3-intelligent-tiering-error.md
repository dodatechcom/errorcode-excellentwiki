---
title: "[Solution] S3 Intelligent-Tiering Configuration Error"
description: "Fix S3 Intelligent-Tiering errors and configure automatic storage class transitions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Intelligent-Tiering Configuration Error

Fix S3 Intelligent-Tiering errors and configure automatic storage class transitions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-intelligent-tiering-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws s3 describe-* 2>&1 | head -50
```
