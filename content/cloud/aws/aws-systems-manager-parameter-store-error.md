---
title: "[Solution] Systems Manager Parameter Store Error"
description: "Resolve Systems Manager Parameter Store errors when accessing stored parameters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Systems Manager Parameter Store Error

Resolve Systems Manager Parameter Store errors when accessing stored parameters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-systems-manager-parameter-store-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws systems describe-* 2>&1 | head -50
```
