---
title: "[Solution] VPC Network ACL Error"
description: "Resolve VPC Network ACL errors when rules block expected traffic."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC Network ACL Error

Resolve VPC Network ACL errors when rules block expected traffic.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-network-acl-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
