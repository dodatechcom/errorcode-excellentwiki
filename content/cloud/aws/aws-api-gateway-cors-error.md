---
title: "[Solution] API Gateway CORS Error"
description: "Fix API Gateway CORS errors when browsers block cross-origin requests to your API."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] API Gateway CORS Error

Fix API Gateway CORS errors when browsers block cross-origin requests to your API.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-api-gateway-cors-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
