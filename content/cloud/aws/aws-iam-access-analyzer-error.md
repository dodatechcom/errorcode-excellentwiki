---
title: "[Solution] IAM Access Analyzer Error"
description: "Fix IAM Access Analyzer errors when checking for external access to resources."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Access Analyzer Error

Fix IAM Access Analyzer errors when checking for external access to resources.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-access-analyzer-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
