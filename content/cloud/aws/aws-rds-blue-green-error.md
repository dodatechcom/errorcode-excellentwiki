---
title: "[Solution] RDS Blue/Green Deployment Error"
description: "Resolve RDS Blue/Green deployment errors when creating zero-downtime updates."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] RDS Blue/Green Deployment Error

Resolve RDS Blue/Green deployment errors when creating zero-downtime updates.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rds-blue-green-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
