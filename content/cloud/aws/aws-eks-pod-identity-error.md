---
title: "[Solution] EKS Pod Identity Error"
description: "Fix EKS Pod Identity errors when pods cannot assume IAM roles for AWS access."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS Pod Identity Error

Fix EKS Pod Identity errors when pods cannot assume IAM roles for AWS access.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-pod-identity-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
