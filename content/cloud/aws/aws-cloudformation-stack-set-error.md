---
title: "[Solution] CloudFormation Stack Set Error"
description: "Resolve CloudFormation StackSet errors when deploying stacks across multiple accounts and regions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Stack Set Error

Resolve CloudFormation StackSet errors when deploying stacks across multiple accounts and regions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-stack-set-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
