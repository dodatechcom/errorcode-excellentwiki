---
title: "[Solution] ECS Task Set Error"
description: "Fix ECS task set errors when using external deployment controllers."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Task Set Error

Fix ECS task set errors when using external deployment controllers.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-task-set-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
