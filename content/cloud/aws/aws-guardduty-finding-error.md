---
title: "[Solution] GuardDuty Finding Processing Error"
description: "Fix GuardDuty finding errors when threat detection findings are not generated."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] GuardDuty Finding Processing Error

Fix GuardDuty finding errors when threat detection findings are not generated.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-guardduty-finding-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws guardduty describe-* 2>&1 | head -50
```
