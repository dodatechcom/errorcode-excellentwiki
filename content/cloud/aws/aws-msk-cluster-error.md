---
title: "[Solution] Amazon MSK Cluster Error"
description: "Fix Amazon MSK cluster errors when managing Apache Kafka clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Amazon MSK Cluster Error

Fix Amazon MSK cluster errors when managing Apache Kafka clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-msk-cluster-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws msk describe-* 2>&1 | head -50
```
