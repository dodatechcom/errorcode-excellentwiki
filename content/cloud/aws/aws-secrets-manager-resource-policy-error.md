---
title: "[Solution] Secrets Manager Resource Policy Error"
description: "Fix Secrets Manager resource policy errors when managing secret access policies."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Secrets Manager Resource Policy Error

Fix Secrets Manager resource policy errors when managing secret access policies.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-secrets-manager-resource-policy-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
