---
title: "[Solution] NAT Gateway Error"
description: "Fix NAT Gateway errors when private subnet instances cannot reach the internet."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] NAT Gateway Error

Fix NAT Gateway errors when private subnet instances cannot reach the internet.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-nat-gateway-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
