---
title: "[Solution] CloudFront Origin Shield Error"
description: "Resolve CloudFront Origin Shield errors when enabling regional caching."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFront Origin Shield Error

Resolve CloudFront Origin Shield errors when enabling regional caching.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudfront-origin-shield-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
