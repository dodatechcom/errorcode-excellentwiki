---
title: "[Solution] SQS FIFO Queue Error"
description: "Resolve SQS FIFO queue ordering and deduplication errors."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SQS FIFO Queue Error

Resolve SQS FIFO queue ordering and deduplication errors.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sqs-fifo-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
