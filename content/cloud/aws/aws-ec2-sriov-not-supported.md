---
title: "[Solution] EC2 SR-IOV Not Supported Error"
description: "Resolve EC2 enhanced networking errors when SR-IOV is not supported on instance type."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 SR-IOV Not Supported Error

Resolve EC2 enhanced networking errors when SR-IOV is not supported on instance type.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-sriov-not-supported   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
