---
title: "[Solution] DynamoDB Time to Live Error"
description: "Resolve DynamoDB TTL errors when items are not being deleted as expected."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] DynamoDB Time to Live Error

Resolve DynamoDB TTL errors when items are not being deleted as expected.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-dynamodb-time-to-live-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
