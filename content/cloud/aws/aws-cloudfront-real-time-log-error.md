---
title: "[Solution] CloudFront Real-Time Log Configuration Error"
description: "Resolve CloudFront real-time log errors when streaming access logs to Kinesis."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFront Real-Time Log Configuration Error

Resolve CloudFront real-time log errors when streaming access logs to Kinesis.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudfront-real-time-log-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
