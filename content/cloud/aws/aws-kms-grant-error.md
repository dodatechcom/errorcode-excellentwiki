---
title: "[Solution] KMS Grant Error"
description: "Fix KMS grant errors when managing cryptographic grants for service access."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] KMS Grant Error

Fix KMS grant errors when managing cryptographic grants for service access.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-kms-grant-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
