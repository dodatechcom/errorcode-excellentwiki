---
title: "[Solution] SNS FIFO Topic Error"
description: "Resolve SNS FIFO topic ordering and deduplication errors."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SNS FIFO Topic Error

Resolve SNS FIFO topic ordering and deduplication errors.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sns-fifo-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
