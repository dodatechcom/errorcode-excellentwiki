---
title: "[Solution] EC2 Termination Protection Enabled Error"
description: "Fix EC2 termination protection errors when unable to terminate instances."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Termination Protection Enabled Error

Fix EC2 termination protection errors when unable to terminate instances.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-termination-protection   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
