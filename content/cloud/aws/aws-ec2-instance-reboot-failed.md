---
title: "[Solution] EC2 Instance Reboot Failed Error"
description: "Fix EC2 instance reboot failures with these troubleshooting steps and AWS CLI commands."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Instance Reboot Failed Error

Fix EC2 instance reboot failures with these troubleshooting steps and AWS CLI commands.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-instance-reboot-failed   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
