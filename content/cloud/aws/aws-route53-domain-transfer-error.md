---
title: "[Solution] Route53 Domain Transfer Error"
description: "Fix Route53 domain transfer errors when transferring domains between registrars."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Route53 Domain Transfer Error

Fix Route53 domain transfer errors when transferring domains between registrars.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-route53-domain-transfer-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
