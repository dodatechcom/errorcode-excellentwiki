---
title: "[Solution] EKS Cluster Upgrade Error"
description: "Fix EKS cluster upgrade errors when updating Kubernetes version on managed control plane."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS Cluster Upgrade Error

Fix EKS cluster upgrade errors when updating Kubernetes version on managed control plane.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-upgrade-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
