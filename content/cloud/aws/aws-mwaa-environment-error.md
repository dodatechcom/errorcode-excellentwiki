---
title: "[Solution] MWAA Environment Error"
description: "Fix Amazon Managed Workflows for Apache Airflow environment errors."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] MWAA Environment Error

Fix Amazon Managed Workflows for Apache Airflow environment errors.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-mwaa-environment-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws mwaa describe-* 2>&1 | head -50
```
