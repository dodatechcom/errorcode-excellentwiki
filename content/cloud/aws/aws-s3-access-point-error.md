---
title: "[Solution] S3 Access Point Configuration Error"
description: "Resolve S3 access point errors when managing data access at scale."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Access Point Configuration Error

Resolve S3 access point errors when managing data access at scale.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-access-point-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
