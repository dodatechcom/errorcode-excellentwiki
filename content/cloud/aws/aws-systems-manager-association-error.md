---
title: "[Solution] Systems Manager Association Error"
description: "Fix Systems Manager association errors when applying patches or configurations."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Systems Manager Association Error

Fix Systems Manager association errors when applying patches or configurations.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-systems-manager-association-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
