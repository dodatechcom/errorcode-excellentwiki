---
title: "[Solution] Lambda Function URL Authentication Error"
description: "Fix Lambda function URL authentication errors when invoking URL endpoints."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Function URL Authentication Error

Fix Lambda function URL authentication errors when invoking URL endpoints.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-url-auth-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
