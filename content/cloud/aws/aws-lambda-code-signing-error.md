---
title: "[Solution] Lambda Code Signing Error"
description: "Resolve Lambda code signing validation errors when deploying signed packages."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Code Signing Error

Resolve Lambda code signing validation errors when deploying signed packages.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-code-signing-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
