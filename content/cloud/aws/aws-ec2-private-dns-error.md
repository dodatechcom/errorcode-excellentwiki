---
title: "[Solution] EC2 Private DNS Name Error"
description: "Fix EC2 private DNS resolution errors in VPC environments."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Private DNS Name Error

Fix EC2 private DNS resolution errors in VPC environments.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-private-dns-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
