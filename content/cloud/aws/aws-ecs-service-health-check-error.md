---
title: "[Solution] ECS Service Health Check Failure Error"
description: "Resolve ECS health check failures when services are marked unhealthy and replaced."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Service Health Check Failure Error

Resolve ECS health check failures when services are marked unhealthy and replaced.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-service-health-check-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
