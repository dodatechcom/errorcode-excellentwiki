---
title: "[Solution] S3 Request Payer Configuration Error"
description: "Resolve S3 requester pays errors when accessing buckets with requester-pays."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Request Payer Configuration Error

Resolve S3 requester pays errors when accessing buckets with requester-pays.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-request-payer-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
