---
title: "[Solution] CloudFormation Nested Stack Error"
description: "Fix CloudFormation nested stack errors when parent stacks fail to create child stacks."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Nested Stack Error

Fix CloudFormation nested stack errors when parent stacks fail to create child stacks.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-nested-stack-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
