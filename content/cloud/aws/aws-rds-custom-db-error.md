---
title: "[Solution] RDS Custom for Oracle/SQL Server Error"
description: "Fix RDS Custom instance errors when customizing database engines on RDS."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] RDS Custom for Oracle/SQL Server Error

Fix RDS Custom instance errors when customizing database engines on RDS.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rds-custom-db-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
