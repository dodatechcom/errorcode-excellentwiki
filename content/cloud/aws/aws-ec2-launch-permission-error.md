---
title: "[Solution] EC2 AMI Launch Permission Error"
description: "Resolve EC2 AMI launch permission errors when sharing images across accounts."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 AMI Launch Permission Error

Resolve EC2 AMI launch permission errors when sharing images across accounts.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-launch-permission-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
