---
title: "[Solution] API Gateway Authorizer Error"
description: "Fix API Gateway authorizer errors when custom Lambda or Cognito authorizers fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] API Gateway Authorizer Error

Fix API Gateway authorizer errors when custom Lambda or Cognito authorizers fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-api-gateway-authorizer-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
