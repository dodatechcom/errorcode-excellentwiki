---
title: "[Solution] CloudFormation Drift Detection Error"
description: "Resolve CloudFormation drift detection errors when resources have been modified outside of CloudFormation."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Drift Detection Error

Resolve CloudFormation drift detection errors when resources have been modified outside of CloudFormation.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-drift-detection-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws cloudformation describe-* 2>&1 | head -50
```
