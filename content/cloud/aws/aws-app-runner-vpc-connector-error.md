---
title: "[Solution] App Runner VPC Connector Error"
description: "Fix App Runner VPC connector errors when connecting services to VPC resources."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] App Runner VPC Connector Error

Fix App Runner VPC connector errors when connecting services to VPC resources.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-app-runner-vpc-connector-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
