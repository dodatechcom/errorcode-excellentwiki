---
title: "[Solution] EMR Cluster Error"
description: "Fix Amazon EMR cluster errors when launching or managing big data clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EMR Cluster Error

Fix Amazon EMR cluster errors when launching or managing big data clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-emr-cluster-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws emr describe-* 2>&1 | head -50
```
