---
title: "[Solution] Lambda Function URL Error"
description: "Fix Lambda function URL errors including CORS authentication and access issues."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Function URL Error

Fix Lambda function URL errors including CORS authentication and access issues.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-function-url-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
