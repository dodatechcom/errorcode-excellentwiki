---
title: "[Solution] VPC Peering Connection Error"
description: "Fix VPC peering errors when connecting two VPCs through peering connections."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC Peering Connection Error

Fix VPC peering errors when connecting two VPCs through peering connections.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-peering-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
