---
title: "[Solution] IAM Inline Policy Limit Exceeded Error"
description: "Resolve IAM inline policy limit exceeded errors when attaching too many policies."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Inline Policy Limit Exceeded Error

Resolve IAM inline policy limit exceeded errors when attaching too many policies.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-inline-policy-limit   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
