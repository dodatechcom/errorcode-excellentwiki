---
title: "[Solution] VPC Private DNS Error"
description: "Fix VPC private hosted zone association errors with Route 53 Resolver."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC Private DNS Error

Fix VPC private hosted zone association errors with Route 53 Resolver.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-private-dns-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
