---
title: "[Solution] EventBridge Archive Error"
description: "Fix EventBridge archive errors when archiving events for replay."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EventBridge Archive Error

Fix EventBridge archive errors when archiving events for replay.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eventbridge-archive-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
