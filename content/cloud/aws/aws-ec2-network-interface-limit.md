---
title: "[Solution] EC2 Network Interface Limit Exceeded"
description: "Resolve EC2 ENI limit errors when attaching multiple network interfaces to instances."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Network Interface Limit Exceeded

Resolve EC2 ENI limit errors when attaching multiple network interfaces to instances.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-network-interface-limit   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
