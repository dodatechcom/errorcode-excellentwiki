---
title: "[Solution] CodePipeline Action Error"
description: "Resolve CodePipeline action errors when individual pipeline actions fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CodePipeline Action Error

Resolve CodePipeline action errors when individual pipeline actions fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-codepipeline-action-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
