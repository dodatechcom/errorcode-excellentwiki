---
title: "[Solution] Neptune Database Connection Error"
description: "Fix Amazon Neptune connection errors when accessing graph database clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Neptune Database Connection Error

Fix Amazon Neptune connection errors when accessing graph database clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-neptune-connection-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws neptune describe-* 2>&1 | head -50
```
