---
title: "[Solution] EC2 Launch Template Error"
description: "Resolve EC2 launch template errors when creating or using versioned templates."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Launch Template Error

Resolve EC2 launch template errors when creating or using versioned templates.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-launch-template-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
