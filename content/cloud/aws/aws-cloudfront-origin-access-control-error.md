---
title: "[Solution] CloudFront Origin Access Control Error"
description: "Resolve CloudFront OAC errors when accessing S3 origins securely."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFront Origin Access Control Error

Resolve CloudFront OAC errors when accessing S3 origins securely.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudfront-origin-access-control-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
