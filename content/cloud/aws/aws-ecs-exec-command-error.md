---
title: "[Solution] ECS Exec Command Error"
description: "Fix ECS Exec errors when trying to execute commands inside running ECS containers."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Exec Command Error

Fix ECS Exec errors when trying to execute commands inside running ECS containers.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-exec-command-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
