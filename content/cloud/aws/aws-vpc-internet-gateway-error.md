---
title: "[Solution] VPC Internet Gateway Error"
description: "Fix VPC internet gateway errors when public instances cannot access the internet."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC Internet Gateway Error

Fix VPC internet gateway errors when public instances cannot access the internet.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-internet-gateway-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
