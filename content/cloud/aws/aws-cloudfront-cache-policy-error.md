---
title: "[Solution] CloudFront Cache Policy Error"
description: "Fix CloudFront cache policy errors when configuring caching behavior."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFront Cache Policy Error

Fix CloudFront cache policy errors when configuring caching behavior.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudfront-cache-policy-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
