---
title: "[Solution] Lambda Event Filter Pattern Error"
description: "Fix Lambda event filter configuration errors for event source mappings."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Event Filter Pattern Error

Fix Lambda event filter configuration errors for event source mappings.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-event-filter-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
