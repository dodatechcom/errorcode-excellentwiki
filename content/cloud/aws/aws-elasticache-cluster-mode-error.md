---
title: "[Solution] ElastiCache Cluster Mode Error"
description: "Fix ElastiCache cluster mode errors when configuring Redis cluster mode."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ElastiCache Cluster Mode Error

Fix ElastiCache cluster mode errors when configuring Redis cluster mode.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-elasticache-cluster-mode-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
