---
title: "[Solution] SES Bounce Rate Error"
description: "Resolve SES bounce rate errors when high bounce rates affect sending reputation."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SES Bounce Rate Error

Resolve SES bounce rate errors when high bounce rates affect sending reputation.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ses-bounce-rate-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
