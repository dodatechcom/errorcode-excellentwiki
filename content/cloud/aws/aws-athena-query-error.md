---
title: "[Solution] Athena Query Error"
description: "Fix Athena query execution errors when querying data in S3."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Athena Query Error

Fix Athena query execution errors when querying data in S3.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-athena-query-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
