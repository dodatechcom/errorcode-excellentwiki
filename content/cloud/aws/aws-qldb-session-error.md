---
title: "[Solution] QLDB Session Error"
description: "Fix Amazon QLDB session errors when connecting to ledger databases."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] QLDB Session Error

Fix Amazon QLDB session errors when connecting to ledger databases.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-qldb-session-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
