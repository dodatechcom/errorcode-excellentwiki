---
title: "[Solution] S3 Bucket Versioning Configuration Error"
description: "Fix S3 bucket versioning errors and enable version control on your S3 buckets."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Bucket Versioning Configuration Error

Fix S3 bucket versioning errors and enable version control on your S3 buckets.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-bucket-versioning-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
