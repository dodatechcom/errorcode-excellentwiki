---
title: "[Solution] IAM Access Key Already Active Error"
description: "Fix IAM access key status errors when trying to activate an already active key."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Access Key Already Active Error

Fix IAM access key status errors when trying to activate an already active key.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-access-key-active-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
