---
title: "[Solution] EC2 Hibernation Error"
description: "Resolve EC2 hibernation errors when instances fail to resume from hibernation."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Hibernation Error

Resolve EC2 hibernation errors when instances fail to resume from hibernation.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-hibernation-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
