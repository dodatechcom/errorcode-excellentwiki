---
title: "[Solution] Lambda Cold Start Timeout Error"
description: "Fix Lambda cold start timeout errors when functions take too long to initialize."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Cold Start Timeout Error

Fix Lambda cold start timeout errors when functions take too long to initialize.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-startup-timeout-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
