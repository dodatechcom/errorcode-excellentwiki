---
title: "[Solution] S3 Bucket Key Encryption Error"
description: "Fix S3 bucket key errors when reducing KMS costs with S3 bucket keys."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Bucket Key Encryption Error

Fix S3 bucket key errors when reducing KMS costs with S3 bucket keys.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-bucket-key-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
