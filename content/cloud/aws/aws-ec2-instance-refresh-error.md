---
title: "[Solution] EC2 Instance Refresh Error"
description: "Resolve Auto Scaling instance refresh errors when rolling out new Launch configurations."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Instance Refresh Error

Resolve Auto Scaling instance refresh errors when rolling out new Launch configurations.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-instance-refresh-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
