---
title: "[Solution] SQS Long Polling Configuration Error"
description: "Fix SQS long polling errors when connections timeout waiting for messages."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SQS Long Polling Configuration Error

Fix SQS long polling errors when connections timeout waiting for messages.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sqs-long-polling-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
