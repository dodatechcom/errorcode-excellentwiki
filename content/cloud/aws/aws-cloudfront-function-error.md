---
title: "[Solution] CloudFront Function Error"
description: "Fix CloudFront function errors when viewer or origin request triggers fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFront Function Error

Fix CloudFront function errors when viewer or origin request triggers fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudfront-function-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
