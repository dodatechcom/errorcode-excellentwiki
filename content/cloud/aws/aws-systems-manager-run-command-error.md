---
title: "[Solution] Systems Manager Run Command Error"
description: "Fix Systems Manager Run Command errors when executing commands on managed instances."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Systems Manager Run Command Error

Fix Systems Manager Run Command errors when executing commands on managed instances.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-systems-manager-run-command-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
