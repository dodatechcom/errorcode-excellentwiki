---
title: "[Solution] ElastiCache Redis AUTH Error"
description: "Resolve ElastiCache Redis AUTH token errors when authentication to clusters fails."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ElastiCache Redis AUTH Error

Resolve ElastiCache Redis AUTH token errors when authentication to clusters fails.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-elasticache-redis-auth-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
