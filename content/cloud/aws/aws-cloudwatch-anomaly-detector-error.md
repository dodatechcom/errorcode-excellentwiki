---
title: "[Solution] CloudWatch Anomaly Detector Error"
description: "Fix CloudWatch anomaly detector errors when configuring predictive scaling."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudWatch Anomaly Detector Error

Fix CloudWatch anomaly detector errors when configuring predictive scaling.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudwatch-anomaly-detector-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws cloudwatch describe-* 2>&1 | head -50
```
