---
title: "[Solution] S3 Storage Analytics Configuration Error"
description: "Resolve S3 analytics configuration errors for storage class analysis on buckets."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Storage Analytics Configuration Error

Resolve S3 analytics configuration errors for storage class analysis on buckets.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-analytics-configuration-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
