---
title: "[Solution] SNS Endpoint Disabled Error"
description: "Resolve SNS endpoint disabled errors when notifications cannot be delivered to endpoints."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SNS Endpoint Disabled Error

Resolve SNS endpoint disabled errors when notifications cannot be delivered to endpoints.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sns-endpoint-disabled-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
