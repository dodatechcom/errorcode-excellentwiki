---
title: "[Solution] ECS Deployment Rollback Error"
description: "Fix ECS deployment rollback errors when a service fails and cannot revert."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Deployment Rollback Error

Fix ECS deployment rollback errors when a service fails and cannot revert.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-deployment-rollback-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
