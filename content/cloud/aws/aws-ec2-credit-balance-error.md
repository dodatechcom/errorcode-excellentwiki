---
title: "[Solution] EC2 CPU Credit Balance Exhausted Error"
description: "Fix EC2 T3/T3a instance CPU credit exhaustion causing throttled performance."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 CPU Credit Balance Exhausted Error

Fix EC2 T3/T3a instance CPU credit exhaustion causing throttled performance.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-credit-balance-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
