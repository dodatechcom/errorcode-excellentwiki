---
title: "[Solution] RDS Proxy Error"
description: "Fix Amazon RDS Proxy errors when managing database connection pooling."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] RDS Proxy Error

Fix Amazon RDS Proxy errors when managing database connection pooling.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rds-proxy-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
