---
title: "[Solution] ElastiCache Node Type Error"
description: "Resolve ElastiCache node type errors when scaling cache clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ElastiCache Node Type Error

Resolve ElastiCache node type errors when scaling cache clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-elasticache-node-type-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
