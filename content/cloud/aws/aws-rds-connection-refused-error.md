---
title: "[Solution] RDS Connection Refused Error"
description: "Fix RDS connection refused errors when applications cannot connect to database instances."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] RDS Connection Refused Error

Fix RDS connection refused errors when applications cannot connect to database instances.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-rds-connection-refused-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
