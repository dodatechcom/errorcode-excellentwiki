---
title: "[Solution] SNS SMS Delivery Error"
description: "Fix SNS SMS delivery errors when text messages fail to send to mobile numbers."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SNS SMS Delivery Error

Fix SNS SMS delivery errors when text messages fail to send to mobile numbers.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sns-sms-delivery-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
