---
title: "[Solution] EventBridge Scheduler Error"
description: "Resolve EventBridge scheduler errors when creating or managing scheduled actions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EventBridge Scheduler Error

Resolve EventBridge scheduler errors when creating or managing scheduled actions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eventbridge-scheduler-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws eventbridge describe-* 2>&1 | head -50
```
