---
title: "[Solution] Route53 Health Check Failure Error"
description: "Fix Route53 health check failures when endpoints are marked unhealthy."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Route53 Health Check Failure Error

Fix Route53 health check failures when endpoints are marked unhealthy.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-route53-health-check-failure-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
