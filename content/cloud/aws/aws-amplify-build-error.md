---
title: "[Solution] Amplify Build Error"
description: "Fix Amplify build errors when deploying frontend applications."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Amplify Build Error

Fix Amplify build errors when deploying frontend applications.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-amplify-build-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
