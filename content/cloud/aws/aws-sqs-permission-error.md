---
title: "[Solution] SQS Access Permission Error"
description: "Resolve SQS permission errors when sending or receiving messages from queues."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SQS Access Permission Error

Resolve SQS permission errors when sending or receiving messages from queues.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sqs-permission-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
