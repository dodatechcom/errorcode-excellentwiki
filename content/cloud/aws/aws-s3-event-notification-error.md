---
title: "[Solution] S3 Event Notification Not Triggering Error"
description: "Fix S3 event notification errors when SNS SQS or Lambda triggers are not firing."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Event Notification Not Triggering Error

Fix S3 event notification errors when SNS SQS or Lambda triggers are not firing.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-event-notification-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
