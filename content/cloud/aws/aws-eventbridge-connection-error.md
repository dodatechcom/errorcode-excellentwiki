---
title: "[Solution] EventBridge Connection Error"
description: "Fix EventBridge connection errors when setting up third-party API integrations."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EventBridge Connection Error

Fix EventBridge connection errors when setting up third-party API integrations.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eventbridge-connection-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
