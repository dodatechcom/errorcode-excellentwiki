---
title: "[Solution] Lambda Log Group Retention Error"
description: "Resolve Lambda CloudWatch log group errors when configuring log retention."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Log Group Retention Error

Resolve Lambda CloudWatch log group errors when configuring log retention.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-log-rotation-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
