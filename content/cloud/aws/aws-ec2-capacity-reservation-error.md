---
title: "[Solution] EC2 Capacity Reservation Error"
description: "Fix EC2 capacity reservation errors when reserving instance capacity fails."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Capacity Reservation Error

Fix EC2 capacity reservation errors when reserving instance capacity fails.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-capacity-reservation-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
