---
title: "[Solution] CodeBuild Source Error"
description: "Resolve CodeBuild source errors when build projects cannot access source repositories."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CodeBuild Source Error

Resolve CodeBuild source errors when build projects cannot access source repositories.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-codebuild-source-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
