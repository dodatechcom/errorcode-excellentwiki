---
title: "[Solution] SNS Topic Policy Error"
description: "Resolve SNS topic policy errors when publishers cannot send messages to topics."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SNS Topic Policy Error

Resolve SNS topic policy errors when publishers cannot send messages to topics.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sns-topic-policy-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
