---
title: "[Solution] Secrets Manager Rotation Error"
description: "Fix Secrets Manager rotation errors when automatic secret rotation fails."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Secrets Manager Rotation Error

Fix Secrets Manager rotation errors when automatic secret rotation fails.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-secrets-manager-rotation-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
