---
title: "[Solution] CloudFormation Change Set Error"
description: "Fix CloudFormation change set errors when creating or executing change sets."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Change Set Error

Fix CloudFormation change set errors when creating or executing change sets.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-change-set-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
