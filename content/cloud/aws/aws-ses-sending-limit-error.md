---
title: "[Solution] SES Sending Limit Error"
description: "Fix SES sending limit errors when email volume exceeds account limits."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SES Sending Limit Error

Fix SES sending limit errors when email volume exceeds account limits.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ses-sending-limit-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
