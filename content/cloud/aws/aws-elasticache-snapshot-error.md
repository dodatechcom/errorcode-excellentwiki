---
title: "[Solution] ElastiCache Snapshot Error"
description: "Fix ElastiCache snapshot errors when creating or restoring from backups."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ElastiCache Snapshot Error

Fix ElastiCache snapshot errors when creating or restoring from backups.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-elasticache-snapshot-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
