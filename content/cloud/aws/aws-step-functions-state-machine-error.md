---
title: "[Solution] Step Functions State Machine Error"
description: "Resolve Step Functions state machine errors when workflow definitions fail."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Step Functions State Machine Error

Resolve Step Functions state machine errors when workflow definitions fail.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-step-functions-state-machine-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
