---
title: "[Solution] VPC CIDR Block Conflict Error"
description: "Fix VPC CIDR block conflict errors when peering or connecting overlapping VPCs."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC CIDR Block Conflict Error

Fix VPC CIDR block conflict errors when peering or connecting overlapping VPCs.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-cidr-conflict-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
