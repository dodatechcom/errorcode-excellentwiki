---
title: "[Solution] EC2 Instance Stopping Timeout Error"
description: "Fix EC2 instances stuck in stopping state with these troubleshooting commands."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EC2 Instance Stopping Timeout Error

Fix EC2 instances stuck in stopping state with these troubleshooting commands.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ec2-stopping-instance-timeout   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
