---
title: "[Solution] SageMaker Notebook Error"
description: "Fix Amazon SageMaker notebook instance errors when accessing ML environments."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SageMaker Notebook Error

Fix Amazon SageMaker notebook instance errors when accessing ML environments.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sagemaker-notebook-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws sagemaker describe-* 2>&1 | head -50
```
