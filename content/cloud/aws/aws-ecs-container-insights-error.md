---
title: "[Solution] ECS Container Insights Error"
description: "Fix ECS Container Insights errors when monitoring container metrics."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] ECS Container Insights Error

Fix ECS Container Insights errors when monitoring container metrics.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-ecs-container-insights-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
