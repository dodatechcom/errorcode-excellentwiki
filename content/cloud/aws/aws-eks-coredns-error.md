---
title: "[Solution] EKS CoreDNS Error"
description: "Fix EKS CoreDNS errors when DNS resolution fails for pods in EKS clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS CoreDNS Error

Fix EKS CoreDNS errors when DNS resolution fails for pods in EKS clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-coredns-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
