---
title: "[Solution] CloudFormation Import Resources Error"
description: "Resolve CloudFormation import errors when bringing existing resources under stack management."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudFormation Import Resources Error

Resolve CloudFormation import errors when bringing existing resources under stack management.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudformation-import-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
