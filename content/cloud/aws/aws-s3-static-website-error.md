---
title: "[Solution] S3 Static Website Hosting Error"
description: "Fix S3 static website hosting errors including access denied and 403 Forbidden responses."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] S3 Static Website Hosting Error

Fix S3 static website hosting errors including access denied and 403 Forbidden responses.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-s3-static-website-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
