---
title: "[Solution] EKS Addon Error"
description: "Fix EKS addon errors when installing or updating managed add-ons on EKS clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS Addon Error

Fix EKS addon errors when installing or updating managed add-ons on EKS clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-addon-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
