---
title: "[Solution] Comprehend Job Error"
description: "Resolve Amazon Comprehend job errors when running NLP analysis tasks."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Comprehend Job Error

Resolve Amazon Comprehend job errors when running NLP analysis tasks.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-comprehend-job-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws comprehend describe-* 2>&1 | head -50
```
