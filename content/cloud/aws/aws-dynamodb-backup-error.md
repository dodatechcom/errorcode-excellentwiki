...
description: "Resolve DynamoDB backup errors when creating or restoring on-demand backups."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] DynamoDB Backup Error

Resolve DynamoDB backup errors when creating or restoring on-demand backups.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-dynamodb-backup-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
