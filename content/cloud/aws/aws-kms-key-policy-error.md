---
title: "[Solution] KMS Key Policy Error"
description: "Fix KMS key policy errors when managing access control for customer managed keys."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] KMS Key Policy Error

Fix KMS key policy errors when managing access control for customer managed keys.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-kms-key-policy-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
