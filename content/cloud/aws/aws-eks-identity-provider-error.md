---
title: "[Solution] EKS Identity Provider Error"
description: "Fix EKS identity provider errors when configuring OIDC or SAML for cluster access."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS Identity Provider Error

Fix EKS identity provider errors when configuring OIDC or SAML for cluster access.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-identity-provider-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
