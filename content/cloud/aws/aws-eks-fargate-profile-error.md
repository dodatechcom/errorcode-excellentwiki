---
title: "[Solution] EKS Fargate Profile Error"
description: "Fix EKS Fargate profile errors when running pods on Fargate for EKS clusters."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] EKS Fargate Profile Error

Fix EKS Fargate profile errors when running pods on Fargate for EKS clusters.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-eks-fargate-profile-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
