---
title: "[Solution] Lambda Circular Dependency Error"
description: "Fix Lambda circular dependency errors when CloudFormation stacks have mutual references."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Circular Dependency Error

Fix Lambda circular dependency errors when CloudFormation stacks have mutual references.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-circular-dependency-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
