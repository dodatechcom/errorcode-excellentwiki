---
title: "[Solution] CloudWatch Dashboard Error"
description: "Fix CloudWatch dashboard errors when creating or viewing custom dashboards."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] CloudWatch Dashboard Error

Fix CloudWatch dashboard errors when creating or viewing custom dashboards.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-cloudwatch-dashboard-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
