---
title: "[Solution] Polly Speech Synthesis Error"
description: "Resolve Amazon Polly text-to-speech errors when generating audio output."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Polly Speech Synthesis Error

Resolve Amazon Polly text-to-speech errors when generating audio output.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-polly-synthesis-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws polly describe-* 2>&1 | head -50
```
