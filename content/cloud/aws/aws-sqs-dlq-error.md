---
title: "[Solution] SQS Dead Letter Queue Error"
description: "Fix SQS dead letter queue errors when messages fail processing and are not routed to DLQ."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SQS Dead Letter Queue Error

Fix SQS dead letter queue errors when messages fail processing and are not routed to DLQ.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sqs-dlq-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
