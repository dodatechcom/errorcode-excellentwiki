---
title: "[Solution] IAM Policy Version Limit Exceeded Error"
description: "Fix IAM policy version limit errors when a managed policy has too many versions."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] IAM Policy Version Limit Exceeded Error

Fix IAM policy version limit errors when a managed policy has too many versions.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-iam-policy-version-limit   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
