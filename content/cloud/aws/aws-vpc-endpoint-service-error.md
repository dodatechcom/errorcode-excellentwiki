---
title: "[Solution] VPC Endpoint Service Error"
description: "Fix VPC endpoint service errors when creating or managing interface and gateway endpoints."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] VPC Endpoint Service Error

Fix VPC endpoint service errors when creating or managing interface and gateway endpoints.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-vpc-endpoint-service-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
