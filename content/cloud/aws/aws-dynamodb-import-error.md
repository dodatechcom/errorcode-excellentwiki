---
title: "[Solution] DynamoDB Import Table Error"
description: "Fix DynamoDB import errors when importing data from S3 into DynamoDB tables."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] DynamoDB Import Table Error

Fix DynamoDB import errors when importing data from S3 into DynamoDB tables.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-dynamodb-import-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
