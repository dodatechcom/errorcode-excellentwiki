---
title: "[Solution] Amazon Lex Bot Error"
description: "Resolve Amazon Lex bot errors when building conversational interfaces."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Amazon Lex Bot Error

Resolve Amazon Lex bot errors when building conversational interfaces.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lex-bot-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws lex describe-* 2>&1 | head -50
```
