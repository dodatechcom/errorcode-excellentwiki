---
title: "[Solution] API Gateway Throttling Error"
description: "Fix API Gateway throttling errors when requests exceed rate limits or burst limits."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] API Gateway Throttling Error

Fix API Gateway throttling errors when requests exceed rate limits or burst limits.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-api-gateway-throttling-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
