---
title: "[Solution] Timestream Write Error"
description: "Resolve Amazon Timestream write errors when ingesting time-series data."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Timestream Write Error

Resolve Amazon Timestream write errors when ingesting time-series data.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-timestream-write-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```

### Enable Detailed Error Logging

```bash
aws timestream describe-* 2>&1 | head -50
```
