---
title: "[Solution] SQS Message Not Found Error"
description: "Fix SQS message not found errors when receiving or processing messages from queues."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] SQS Message Not Found Error

Fix SQS message not found errors when receiving or processing messages from queues.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-sqs-message-not-found-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
