---
title: "[Solution] Lambda Container Image Size Limit Error"
description: "Resolve Lambda container image too large errors when deploying functions with Docker images."
cloud: ["aws"]
error-types: ["cloud-error"]
---

# [Solution] Lambda Container Image Size Limit Error

Resolve Lambda container image too large errors when deploying functions with Docker images.
...
```bash
aws logs filter-log-events   --log-group-name /aws/aws-lambda-image-size-error   --start-time $(date -d '1 hour ago' +%s)000   --filter-pattern "ERROR"
```
