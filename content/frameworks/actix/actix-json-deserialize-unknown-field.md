---
title: "JSON deserialize unknown field"
description: "Actix Json extractor fails because the request body contains an unknown field and the deserialization config has deny_unknown_fields enabled"
frameworks: ['actix']
...
This error occurs when actix json extractor fails because the request body contains an unknown field and the deserialization config has deny_unknown_fields enabled.
