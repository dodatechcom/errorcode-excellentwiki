---
title: "Request ID middleware not configured"
description: "Actix application does not propagate the X-Request-ID header because the tracing middleware was not added to the middleware stack"
frameworks: ['actix']
...
This error occurs when actix application does not propagate the x-request-id header because the tracing middleware was not added to the middleware stack.
