---
title: "Cookie signature mismatch"
description: "Actix cookie middleware rejects the session cookie because the HMAC signature does not match due to a rotated signing key"
frameworks: ['actix']
...
This error occurs when actix cookie middleware rejects the session cookie because the hmac signature does not match due to a rotated signing key.
