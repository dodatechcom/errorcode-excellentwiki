---
title: "Permanent redirect infinite loop"
description: "Actix Redirect::permanent sends a 301 redirect to a URL that resolves back to the same route creating an infinite redirect cycle"
frameworks: ['actix']
...
This error occurs when actix redirect::permanent sends a 301 redirect to a url that resolves back to the same route creating an infinite redirect cycle.
