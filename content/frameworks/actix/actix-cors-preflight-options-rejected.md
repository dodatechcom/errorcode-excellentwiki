---
title: "CORS preflight OPTIONS rejected"
description: "Actix CORS middleware does not handle the OPTIONS preflight request because the method is not explicitly routed in the application"
frameworks: ['actix']
...
This error occurs when actix cors middleware does not handle the options preflight request because the method is not explicitly routed in the application.
