---
title: "App data type mismatch panic"
description: "Actix handler panics when extracting typed app data because the stored value is a different type than what the handler expects"
frameworks: ['actix']
...
This error occurs when actix handler panics when extracting typed app data because the stored value is a different type than what the handler expects.
