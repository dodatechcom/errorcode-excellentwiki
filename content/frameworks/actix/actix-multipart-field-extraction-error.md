---
title: "Multipart field extraction error"
description: "Actix multipart form handler cannot extract a required text field because the Content-Type boundary header is missing or malformed"
frameworks: ['actix']
...
This error occurs when actix multipart form handler cannot extract a required text field because the content-type boundary header is missing or malformed.
