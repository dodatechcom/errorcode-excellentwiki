---
title: "Content-Type unsupported error"
description: "Actix handler returns a 415 Unsupported Media Type because the request Content-Type header does not match any registered extractor"
frameworks: ['actix']
...
This error occurs when actix handler returns a 415 unsupported media type because the request content-type header does not match any registered extractor.
