---
title: "Cache key generator collision"
description: "Actix response cache middleware returns incorrect cached responses because the key generator produces identical keys for different request paths"
frameworks: ['actix']
...
This error occurs when actix response cache middleware returns incorrect cached responses because the key generator produces identical keys for different request paths.
