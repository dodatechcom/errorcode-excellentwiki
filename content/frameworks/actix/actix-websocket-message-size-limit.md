...
description: "Actix WebSocket handler rejects an incoming message because its size exceeds the maximum configured frame size in the WebSocket protocol"
frameworks: ['actix']
...
This error occurs when actix websocket handler rejects an incoming message because its size exceeds the maximum configured frame size in the websocket protocol.
