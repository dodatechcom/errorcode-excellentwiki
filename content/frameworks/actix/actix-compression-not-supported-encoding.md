---
title: "Compression encoding not supported"
description: "Actix compression middleware cannot encode the response because the client Accept-Encoding header contains only unsupported algorithms"
frameworks: ['actix']
...
This error occurs when actix compression middleware cannot encode the response because the client accept-encoding header contains only unsupported algorithms.
