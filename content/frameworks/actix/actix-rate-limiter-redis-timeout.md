---
title: "Rate limiter Redis timeout"
description: "Actix rate limiter middleware times out trying to increment the request counter in Redis causing all requests to be temporarily blocked"
frameworks: ['actix']
...
This error occurs when actix rate limiter middleware times out trying to increment the request counter in redis causing all requests to be temporarily blocked.
