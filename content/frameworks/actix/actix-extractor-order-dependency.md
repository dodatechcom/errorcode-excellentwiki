---
title: "Extractor order dependency error"
description: "Actix handler fails because multiple extractors consume the request body and the second extractor receives an empty payload"
frameworks: ['actix']
...
This error occurs when actix handler fails because multiple extractors consume the request body and the second extractor receives an empty payload.
