---
title: "CORS exposed headers missing"
description: "Actix CORS middleware does not include the required custom headers in Access-Control-Expose-Headers causing the browser to hide them from JavaScript"
frameworks: ['actix']
...
This error occurs when actix cors middleware does not include the required custom headers in access-control-expose-headers causing the browser to hide them from javascript.
