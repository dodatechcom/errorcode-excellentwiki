---
title: "WebSocket actor mailbox full"
description: "Actix WebSocket actor message mailbox is full because the server is sending messages faster than the client can process them"
frameworks: ['actix']
...
This error occurs when actix websocket actor message mailbox is full because the server is sending messages faster than the client can process them.
