---
title: "Test request not finalized"
description: "Actix unit test does not call finish on the TestRequest creating an inconsistent state where the request body is never consumed"
frameworks: ['actix']
...
This error occurs when actix unit test does not call finish on the testrequest creating an inconsistent state where the request body is never consumed.
