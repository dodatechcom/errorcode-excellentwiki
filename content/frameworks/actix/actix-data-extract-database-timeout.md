---
title: "Data extract database connection timeout"
description: "Actix handler cannot extract the database connection from the pool because all connections are in use and the timeout expires"
frameworks: ['actix']
...
This error occurs when actix handler cannot extract the database connection from the pool because all connections are in use and the timeout expires.
