---
title: "Response body streaming error"
description: "Actix streaming response body fails mid-transfer because the upstream data source closes the connection before all chunks are flushed"
frameworks: ['actix']
...
This error occurs when actix streaming response body fails mid-transfer because the upstream data source closes the connection before all chunks are flushed.
