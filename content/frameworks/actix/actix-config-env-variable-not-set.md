---
title: "Config environment variable not set"
description: "Actix configuration builder cannot substitute the environment variable placeholder because the variable is not defined in the runtime environment"
frameworks: ['actix']
...
This error occurs when actix configuration builder cannot substitute the environment variable placeholder because the variable is not defined in the runtime environment.
