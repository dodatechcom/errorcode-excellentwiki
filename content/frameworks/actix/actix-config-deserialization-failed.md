---
title: "Config deserialization failed"
description: "Actix cannot deserialize the application configuration from TOML because a required field is missing or has the wrong data type"
frameworks: ['actix']
...
This error occurs when actix cannot deserialize the application configuration from toml because a required field is missing or has the wrong data type.
