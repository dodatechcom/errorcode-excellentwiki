---
title: "JSON extract payload too large"
description: "Actix Json extractor rejects the request body because the content-length exceeds the default payload size limit configured in the app data"
frameworks: ['actix']
...
This error occurs when actix json extractor rejects the request body because the content-length exceeds the default payload size limit configured in the app data.
