---
title: "Helpers body read error"
description: "Actix web::body::to_bytes fails to read the request body because the client closed the connection before sending the full payload"
frameworks: ['actix']
...
This error occurs when actix web::body::to_bytes fails to read the request body because the client closed the connection before sending the full payload.
