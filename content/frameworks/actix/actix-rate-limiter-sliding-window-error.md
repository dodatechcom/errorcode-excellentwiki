---
title: "Rate limiter sliding window error"
description: "Actix sliding window rate limiter miscalculates the request count because the window timestamps are not synchronized with the system clock"
frameworks: ['actix']
...
This error occurs when actix sliding window rate limiter miscalculates the request count because the window timestamps are not synchronized with the system clock.
