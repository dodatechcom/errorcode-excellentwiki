---
title: "Multipart file upload limit exceeded"
description: "Actix multipart form handler rejects file uploads that exceed the configured max size returning a 413 Payload Too Large response"
frameworks: ['actix']
...
This error occurs when actix multipart form handler rejects file uploads that exceed the configured max size returning a 413 payload too large response.
