---
title: "Recovery middleware stack overflow"
description: "Actix recovery middleware encounters a stack overflow during panic unwinding because the panic message itself is extremely large"
frameworks: ['actix']
...
This error occurs when actix recovery middleware encounters a stack overflow during panic unwinding because the panic message itself is extremely large.
