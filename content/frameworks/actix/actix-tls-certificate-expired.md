...
description: "Actix TLS server rejects all incoming HTTPS connections because the loaded certificate has passed its NotAfter expiration date"
frameworks: ['actix']
...
This error occurs when actix tls server rejects all incoming https connections because the loaded certificate has passed its notafter expiration date.
