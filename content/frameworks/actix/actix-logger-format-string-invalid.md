...
description: "Actix logger middleware panics during request logging because the format string contains unsupported directives for the request type"
frameworks: ['actix']
...
This error occurs when actix logger middleware panics during request logging because the format string contains unsupported directives for the request type.
