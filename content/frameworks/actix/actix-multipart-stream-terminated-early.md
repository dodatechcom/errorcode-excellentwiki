---
title: "Multipart stream terminated early"
description: "Actix multipart parser encounters an unexpected end of stream because the client closes the connection before sending the final boundary"
frameworks: ['actix']
...
This error occurs when actix multipart parser encounters an unexpected end of stream because the client closes the connection before sending the final boundary.
