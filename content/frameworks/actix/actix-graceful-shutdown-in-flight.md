---
title: "Graceful shutdown in-flight requests"
description: "Actix server terminates in-flight HTTP requests during graceful shutdown because the shutdown timeout is shorter than the longest request"
frameworks: ['actix']
...
This error occurs when actix server terminates in-flight http requests during graceful shutdown because the shutdown timeout is shorter than the longest request.
