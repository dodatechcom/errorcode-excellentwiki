---
title: "WebSocket heartbeat timeout"
description: "Actix WebSocket actor does not receive a pong response within the heartbeat interval causing the connection to be forcibly closed"
frameworks: ['actix']
...
This error occurs when actix websocket actor does not receive a pong response within the heartbeat interval causing the connection to be forcibly closed.
