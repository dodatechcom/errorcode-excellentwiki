---
title: "HTTP Basic Auth missing header"
description: "Actix HTTPBasicAuth extractor fails because the Authorization header is not present in the incoming request"
frameworks: ['actix']
...
This error occurs when actix httpbasicauth extractor fails because the authorization header is not present in the incoming request.
