---
title: "Static file directory traversal attempt"
description: "Actix static file server detects a path traversal sequence in the URL and rejects the request returning a 403 Forbidden response"
frameworks: ['actix']
...
This error occurs when actix static file server detects a path traversal sequence in the url and rejects the request returning a 403 forbidden response.
