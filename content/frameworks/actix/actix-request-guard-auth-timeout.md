---
title: "Request guard authentication timeout"
description: "Actix authentication guard times out while validating the JWT token because the auth service is unreachable or responding slowly"
frameworks: ['actix']
...
This error occurs when actix authentication guard times out while validating the jwt token because the auth service is unreachable or responding slowly.
