---
title: "Test server port already in use"
description: "Actix test server cannot start because the configured port is already bound by another test running in parallel in the CI environment"
frameworks: ['actix']
...
This error occurs when actix test server cannot start because the configured port is already bound by another test running in parallel in the ci environment.
