---
title: "CORS AllowHeaders not matching"
description: "Actix CORS preflight response does not include the requested custom header in Access-Control-Allow-Headers causing the browser to block the request"
frameworks: ['actix']
...
This error occurs when actix cors preflight response does not include the requested custom header in access-control-allow-headers causing the browser to block the request.
