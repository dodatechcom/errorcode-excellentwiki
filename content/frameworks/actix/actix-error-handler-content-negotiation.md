---
title: "Error handler content negotiation"
description: "Actix custom error handler fails to serialize the error response because the client Accept header requests a format not supported by the serializer"
frameworks: ['actix']
...
This error occurs when actix custom error handler fails to serialize the error response because the client accept header requests a format not supported by the serializer.
