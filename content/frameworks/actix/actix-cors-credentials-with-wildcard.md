...
description: "Actix CORS middleware sets both allow-credentials to true and allow-origin to wildcard causing the browser to reject the response"
frameworks: ['actix']
...
This error occurs when actix cors middleware sets both allow-credentials to true and allow-origin to wildcard causing the browser to reject the response.
