---
title: "WebSocket protocol negotiation failed"
description: "Actix WebSocket handler cannot negotiate the subprotocol because the client Sec-WebSocket-Protocol header does not match any server offering"
frameworks: ['actix']
...
This error occurs when actix websocket handler cannot negotiate the subprotocol because the client sec-websocket-protocol header does not match any server offering.
