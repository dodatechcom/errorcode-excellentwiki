---
title: "Health check database timeout"
description: "Actix health endpoint times out trying to ping the PostgreSQL database causing the Kubernetes readiness probe to fail"
frameworks: ['actix']
...
This error occurs when actix health endpoint times out trying to ping the postgresql database causing the kubernetes readiness probe to fail.
