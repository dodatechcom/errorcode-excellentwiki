...
description: "Actix custom middleware does not call service.call causing the request to hang indefinitely without any response"
frameworks: ['actix']
...
This error occurs when actix custom middleware does not call service.call causing the request to hang indefinitely without any response.
