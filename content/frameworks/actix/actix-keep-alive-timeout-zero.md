---
title: "Keep-alive timeout zero value"
description: "Actix server does not close idle keep-alive connections because the keep-alive timeout is set to zero disabling connection recycling"
frameworks: ['actix']
...
This error occurs when actix server does not close idle keep-alive connections because the keep-alive timeout is set to zero disabling connection recycling.
