...
description: "Flutter throws a FlutterError when setState is called on a State object that has already been disposed"
frameworks: ["flutter"]
...
This error occurs when `setState` is called on a widget's State object after it has been removed from the widget tree and disposed. This typically happens with async operations that complete after the widget is unmounted.
...
- [Navigator error]({{< relref "/frameworks/flutter/navigation-error2" >}})
