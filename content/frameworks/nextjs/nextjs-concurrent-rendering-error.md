---
title: "Concurrent rendering error in RSC"
description: "React Server Component encounters a concurrent rendering error when an async boundary resolves with conflicting Suspense states"
frameworks: ['nextjs']
...
This error occurs when react server component encounters a concurrent rendering error when an async boundary resolves with conflicting suspense states.
