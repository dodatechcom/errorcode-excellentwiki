---
title: "Server action cookies error"
description: "Next.js Server Action cannot set cookies because the response headers have already been sent by a prior redirect in the same action"
frameworks: ['nextjs']
...
This error occurs when next.js server action cannot set cookies because the response headers have already been sent by a prior redirect in the same action.
