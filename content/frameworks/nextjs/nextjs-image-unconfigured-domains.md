---
title: "Image unconfigured domains error"
description: "Next.js Image component rejects an external image URL because the domain is not listed in next.config.js image domains configuration"
frameworks: ['nextjs']
...
This error occurs when next.js image component rejects an external image url because the domain is not listed in next.config.js image domains configuration.
