---
title: "i18n default locale redirect loop"
description: "Next.js i18n configuration causes an infinite redirect when the default locale redirect logic does not exclude the root path"
frameworks: ['nextjs']
...
This error occurs when next.js i18n configuration causes an infinite redirect when the default locale redirect logic does not exclude the root path.
