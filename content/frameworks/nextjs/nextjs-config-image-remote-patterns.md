---
title: "Image remote patterns invalid"
description: "Next.js next.config.js images.remotePatterns uses an invalid hostname pattern causing all remote images to be rejected by the image optimizer"
frameworks: ['nextjs']
...
This error occurs when next.js next.config.js images.remotepatterns uses an invalid hostname pattern causing all remote images to be rejected by the image optimizer.
