---
title: "Local font file missing error"
description: "Next.js next/font/local cannot find the specified font file path causing the build to fail with a file not found error"
frameworks: ['nextjs']
...
This error occurs when next.js next/font/local cannot find the specified font file path causing the build to fail with a file not found error.
