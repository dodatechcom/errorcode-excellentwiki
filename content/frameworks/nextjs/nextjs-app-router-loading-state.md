---
title: "App Router loading state error"
description: "Next.js loading.tsx file throws an error during Suspense boundary rendering causing the entire route segment to fail"
frameworks: ['nextjs']
...
This error occurs when next.js loading.tsx file throws an error during suspense boundary rendering causing the entire route segment to fail.
