---
title: "Trailing slash configuration mismatch"
description: "Next.js trailingSlash option causes client-side navigation to break when the server and client disagree on URL normalization"
frameworks: ['nextjs']
...
This error occurs when next.js trailingslash option causes client-side navigation to break when the server and client disagree on url normalization.
