---
title: "Analytics integration script error"
description: "Next.js third-party analytics script fails to load due to Content Security Policy blocking the external script domain"
frameworks: ['nextjs']
...
This error occurs when next.js third-party analytics script fails to load due to content security policy blocking the external script domain.
