---
title: "Server component dynamic import error"
description: "Next.js server component uses dynamic import with a variable path that cannot be statically analyzed by the bundler at build time"
frameworks: ['nextjs']
...
This error occurs when next.js server component uses dynamic import with a variable path that cannot be statically analyzed by the bundler at build time.
