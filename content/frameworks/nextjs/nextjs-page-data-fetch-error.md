---
title: "Page data fetch error during SSR"
description: "Next.js server-side rendering fails when data fetching in getServerSideProps or server component throws an unhandled promise rejection"
frameworks: ['nextjs']
...
This error occurs when next.js server-side rendering fails when data fetching in getserversideprops or server component throws an unhandled promise rejection.
