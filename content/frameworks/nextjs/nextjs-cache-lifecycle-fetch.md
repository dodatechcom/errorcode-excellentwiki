---
title: "Cache lifecycle fetch error"
description: "Next.js unstable_cache or fetch cache throws a TypeError when the cache handler returns an unexpected data format during hydration"
frameworks: ['nextjs']
...
This error occurs when next.js unstable_cache or fetch cache throws a typeerror when the cache handler returns an unexpected data format during hydration.
