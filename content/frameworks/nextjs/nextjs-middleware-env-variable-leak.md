---
title: "Middleware environment variable leak"
description: "Next.js middleware accidentally exposes a server-only environment variable to the client bundle through an import chain that crosses the boundary"
frameworks: ['nextjs']
...
This error occurs when next.js middleware accidentally exposes a server-only environment variable to the client bundle through an import chain that crosses the boundary.
