---
title: "Output file tracing error"
description: "Next.js standalone output mode fails to trace required files because a dynamic import path cannot be resolved at build time"
frameworks: ['nextjs']
...
This error occurs when next.js standalone output mode fails to trace required files because a dynamic import path cannot be resolved at build time.
