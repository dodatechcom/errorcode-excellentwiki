---
title: "Server action form data parse error"
description: "Next.js Server Action receives malformed multipart form data and fails to parse the incoming request body"
frameworks: ['nextjs']
...
This error occurs when next.js server action receives malformed multipart form data and fails to parse the incoming request body.
