---
title: "Server component uses client hook"
description: "A React Server Component attempts to use a client-only hook like useState or useEffect causing a build failure"
frameworks: ['nextjs']
...
This error occurs when a react server component attempts to use a client-only hook like usestate or useeffect causing a build failure.
