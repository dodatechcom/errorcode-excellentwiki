---
title: "Server action encryption error"
description: "Next.js Server Action encryption fails because the action ID has been invalidated by a server restart without clearing the build cache"
frameworks: ['nextjs']
...
This error occurs when next.js server action encryption fails because the action id has been invalidated by a server restart without clearing the build cache.
