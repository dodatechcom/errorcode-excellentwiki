---
title: "Image loader configuration error"
description: "Next.js custom image loader is misconfigured in next.config.js causing all Image components to fail rendering external URLs"
frameworks: ['nextjs']
...
This error occurs when next.js custom image loader is misconfigured in next.config.js causing all image components to fail rendering external urls.
