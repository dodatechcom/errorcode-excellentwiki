---
title: "Rewrites source pattern missing"
description: "Next.js rewrites configuration references a source path that does not match any incoming request pattern in the router"
frameworks: ['nextjs']
...
This error occurs when next.js rewrites configuration references a source path that does not match any incoming request pattern in the router.
