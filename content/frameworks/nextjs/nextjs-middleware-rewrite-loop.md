---
title: "Middleware infinite rewrite loop"
description: "Next.js middleware rewrites a request to a URL that triggers the same middleware again creating an infinite loop"
frameworks: ['nextjs']
...
This error occurs when next.js middleware rewrites a request to a url that triggers the same middleware again creating an infinite loop.
