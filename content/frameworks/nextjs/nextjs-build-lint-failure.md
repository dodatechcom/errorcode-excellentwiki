---
title: "Build ESLint configuration failure"
description: "Next.js build fails because the ESLint config references a plugin or rule that is not installed in the project dependencies"
frameworks: ['nextjs']
...
This error occurs when next.js build fails because the eslint config references a plugin or rule that is not installed in the project dependencies.
