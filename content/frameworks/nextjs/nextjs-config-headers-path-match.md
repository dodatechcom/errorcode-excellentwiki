---
title: "Config headers path match error"
description: "Next.js next.config.js headers configuration uses an invalid glob pattern causing headers to not be applied to any routes"
frameworks: ['nextjs']
...
This error occurs when next.js next.config.js headers configuration uses an invalid glob pattern causing headers to not be applied to any routes.
