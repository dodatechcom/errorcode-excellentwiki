---
title: "Runtime config missing variable"
description: "Next.js runtimeConfig or publicRuntimeConfig references an environment variable that is not defined at build time"
frameworks: ['nextjs']
...
This error occurs when next.js runtimeconfig or publicruntimeconfig references an environment variable that is not defined at build time.
