---
title: "Form action redirect error"
description: "Next.js server action calls redirect inside a try-catch block causing an uncatchable NEXT_REDIRECT error to propagate unexpectedly"
frameworks: ['nextjs']
...
This error occurs when next.js server action calls redirect inside a try-catch block causing an uncatchable next_redirect error to propagate unexpectedly.
