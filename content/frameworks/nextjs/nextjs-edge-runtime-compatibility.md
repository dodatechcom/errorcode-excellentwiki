---
title: "Edge Runtime compatibility error"
description: "Next.js Edge Runtime cannot execute code that uses Node.js-only APIs like fs or crypto模块 causing a runtime crash"
frameworks: ['nextjs']
...
This error occurs when next.js edge runtime cannot execute code that uses node.js-only apis like fs or crypto模块 causing a runtime crash.
