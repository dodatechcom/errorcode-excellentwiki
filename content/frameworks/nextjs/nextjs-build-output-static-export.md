---
title: "Static export build output error"
description: "Next.js static export fails because a page uses dynamic server features that are incompatible with output export mode"
frameworks: ['nextjs']
...
This error occurs when next.js static export fails because a page uses dynamic server features that are incompatible with output export mode.
