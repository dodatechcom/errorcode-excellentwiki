---
title: "getStaticPaths fallback error"
description: "Next.js getStaticPaths returns paths without fallback enabled and a request comes for a path not in the list"
frameworks: ['nextjs']
...
This error occurs when next.js getstaticpaths returns paths without fallback enabled and a request comes for a path not in the list.
