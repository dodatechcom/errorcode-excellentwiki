---
title: "Route segment config dynamic override"
description: "Next.js route segment config export sets dynamic to force-dynamic but the page is statically generated causing a conflict"
frameworks: ['nextjs']
...
This error occurs when next.js route segment config export sets dynamic to force-dynamic but the page is statically generated causing a conflict.
