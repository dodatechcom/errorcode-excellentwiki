---
title: "Partial Prerender missing shell"
description: "Next.js PPR mode cannot render a page because the required outer shell layout is missing or does not export a default component"
frameworks: ['nextjs']
...
This error occurs when next.js ppr mode cannot render a page because the required outer shell layout is missing or does not export a default component.
