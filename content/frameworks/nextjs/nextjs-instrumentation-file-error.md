---
title: "Instrumentation file error"
description: "Next.js instrumentation.ts file throws during server startup causing the entire application to fail to initialize"
frameworks: ['nextjs']
...
This error occurs when next.js instrumentation.ts file throws during server startup causing the entire application to fail to initialize.
