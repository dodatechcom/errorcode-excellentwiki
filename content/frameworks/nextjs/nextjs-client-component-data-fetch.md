---
title: "Client component data fetching error"
description: "Next.js client component fetches data on mount but fails due to missing CORS headers from the external API endpoint"
frameworks: ['nextjs']
...
This error occurs when next.js client component fetches data on mount but fails due to missing cors headers from the external api endpoint.
