---
title: "Logger latency format error"
description: "Fiber logger middleware reports incorrect request latency because the time measurement does not account for middleware execution time"
frameworks: ['fiber']
...
This error occurs when fiber logger middleware reports incorrect request latency because the time measurement does not account for middleware execution time.
