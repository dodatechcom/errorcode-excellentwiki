---
title: "Config parse error in JSON file"
description: "Fiber cannot parse the JSON configuration file because a trailing comma or a missing quote breaks the JSON syntax validation"
frameworks: ['fiber']
...
This error occurs when fiber cannot parse the json configuration file because a trailing comma or a missing quote breaks the json syntax validation.
