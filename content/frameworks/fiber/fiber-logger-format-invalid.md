---
title: "Logger format string invalid"
description: "Fiber logger middleware panics during request logging because the format string contains unsupported verbs for the fiber context type"
frameworks: ['fiber']
...
This error occurs when fiber logger middleware panics during request logging because the format string contains unsupported verbs for the fiber context type.
