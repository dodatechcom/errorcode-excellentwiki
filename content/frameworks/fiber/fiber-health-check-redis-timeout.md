---
title: "Health check Redis timeout"
description: "Fiber health endpoint times out trying to ping the Redis store causing Kubernetes liveness probe to mark the pod as unhealthy"
frameworks: ['fiber']
...
This error occurs when fiber health endpoint times out trying to ping the redis store causing kubernetes liveness probe to mark the pod as unhealthy.
