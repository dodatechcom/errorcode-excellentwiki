---
title: "Request ID header duplicated"
description: "Fiber request ID middleware generates a new ID for every internal redirect instead of preserving the original X-Request-ID across the chain"
frameworks: ['fiber']
...
This error occurs when fiber request id middleware generates a new id for every internal redirect instead of preserving the original x-request-id across the chain.
