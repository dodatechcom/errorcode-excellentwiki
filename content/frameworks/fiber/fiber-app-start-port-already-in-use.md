---
title: "App start port already in use"
description: "Fiber server fails to bind to the configured port because another process is already listening on the same address"
frameworks: ['fiber']
...
This error occurs when fiber server fails to bind to the configured port because another process is already listening on the same address.
