---
title: "App config nested struct error"
description: "Fiber cannot deserialize the configuration into the custom struct because a nested field uses a type that is not supported by the parser"
frameworks: ['fiber']
...
This error occurs when fiber cannot deserialize the configuration into the custom struct because a nested field uses a type that is not supported by the parser.
