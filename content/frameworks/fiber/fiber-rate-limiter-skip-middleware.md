---
title: "Rate limiter skips middleware chain"
description: "Fiber rate limiter middleware does not stop processing when the limit is exceeded causing the handler to still execute after sending a 429"
frameworks: ['fiber']
...
This error occurs when fiber rate limiter middleware does not stop processing when the limit is exceeded causing the handler to still execute after sending a 429.
