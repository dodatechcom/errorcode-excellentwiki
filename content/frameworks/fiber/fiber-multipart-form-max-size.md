---
title: "Multipart form max size exceeded"
description: "Fiber multipart form handler rejects file uploads that exceed the configured MaxMultipartSize causing a 413 response"
frameworks: ['fiber']
...
This error occurs when fiber multipart form handler rejects file uploads that exceed the configured maxmultipartsize causing a 413 response.
