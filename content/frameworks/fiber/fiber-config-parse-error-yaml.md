---
title: "Config parse error in YAML file"
description: "Fiber cannot load the configuration from yaml file because a nested key uses incorrect indentation or an invalid data type"
frameworks: ['fiber']
...
This error occurs when fiber cannot load the configuration from yaml file because a nested key uses incorrect indentation or an invalid data type.
