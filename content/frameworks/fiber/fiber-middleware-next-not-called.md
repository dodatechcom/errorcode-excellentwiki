...
description: "Fiber custom middleware does not call c.Next() causing the request to hang indefinitely without any response being sent to the client"
frameworks: ['fiber']
...
This error occurs when fiber custom middleware does not call c.next() causing the request to hang indefinitely without any response being sent to the client.
