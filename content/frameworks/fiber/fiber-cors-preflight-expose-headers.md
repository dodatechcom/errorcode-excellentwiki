---
title: "CORS preflight ExposeHeaders issue"
description: "Fiber CORS preflight response includes headers in ExposeHeaders that were not included in the AllowHeaders list causing browser confusion"
frameworks: ['fiber']
...
This error occurs when fiber cors preflight response includes headers in exposeheaders that were not included in the allowheaders list causing browser confusion.
