---
title: "CORS AllowOrigin list empty"
description: "Fiber CORS middleware returns an empty Access-Control-Allow-Origin header because no origins are configured in the AllowOrigins field"
frameworks: ['fiber']
...
This error occurs when fiber cors middleware returns an empty access-control-allow-origin header because no origins are configured in the alloworigins field.
