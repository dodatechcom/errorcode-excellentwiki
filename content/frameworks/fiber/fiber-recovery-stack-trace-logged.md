---
title: "Recovery stack trace logged to stdout"
description: "Fiber recovery middleware prints full stack traces to stdout in production causing log storage costs to spike under high error rates"
frameworks: ['fiber']
...
This error occurs when fiber recovery middleware prints full stack traces to stdout in production causing log storage costs to spike under high error rates.
