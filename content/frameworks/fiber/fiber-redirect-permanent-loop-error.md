---
title: "Permanent redirect creates loop"
description: "Fiber Redirect middleware sends a 301 redirect to a URL that resolves back to the same route creating an infinite redirect cycle"
frameworks: ['fiber']
...
This error occurs when fiber redirect middleware sends a 301 redirect to a url that resolves back to the same route creating an infinite redirect cycle.
