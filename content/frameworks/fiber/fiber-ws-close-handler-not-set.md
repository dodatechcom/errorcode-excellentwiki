---
title: "WebSocket close handler not set"
description: "Fiber WebSocket connection is not properly closed when the client disconnects because the CloseHandler was never registered"
frameworks: ['fiber']
...
This error occurs when fiber websocket connection is not properly closed when the client disconnects because the closehandler was never registered.
