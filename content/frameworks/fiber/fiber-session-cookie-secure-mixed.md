---
title: "Session cookie secure flag mixed"
description: "Fiber session middleware sets Secure flag on cookies but the server is running over HTTP in development causing browsers to reject the cookie"
frameworks: ['fiber']
...
This error occurs when fiber session middleware sets secure flag on cookies but the server is running over http in development causing browsers to reject the cookie.
