---
title: "CORS preflight max age negative"
description: "Fiber CORS middleware sets a negative Access-Control-Max-Age value causing the browser to ignore the preflight cache entirely"
frameworks: ['fiber']
...
This error occurs when fiber cors middleware sets a negative access-control-max-age value causing the browser to ignore the preflight cache entirely.
