---
title: "Config default value overridden"
description: "Fiber configuration file sets a zero value for a numeric field causing the framework to use its internal default instead of the intended value"
frameworks: ['fiber']
...
This error occurs when fiber configuration file sets a zero value for a numeric field causing the framework to use its internal default instead of the intended value.
