---
title: "Basic auth storage error"
description: "Fiber BasicAuth middleware fails to validate credentials because the in-memory user store was not initialized before starting the server"
frameworks: ['fiber']
...
This error occurs when fiber basicauth middleware fails to validate credentials because the in-memory user store was not initialized before starting the server.
