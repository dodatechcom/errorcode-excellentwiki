---
title: "Proxy streaming response error"
description: "Fiber proxy middleware drops the connection during streaming because the upstream closes before the response is fully flushed"
frameworks: ['fiber']
...
This error occurs when fiber proxy middleware drops the connection during streaming because the upstream closes before the response is fully flushed.
