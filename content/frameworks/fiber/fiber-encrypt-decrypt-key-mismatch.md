---
title: "Encrypt decrypt key mismatch"
description: "Fiber encryption middleware fails to decrypt cookies because the encryption key was rotated without re-encrypting existing session data"
frameworks: ['fiber']
...
This error occurs when fiber encryption middleware fails to decrypt cookies because the encryption key was rotated without re-encrypting existing session data.
