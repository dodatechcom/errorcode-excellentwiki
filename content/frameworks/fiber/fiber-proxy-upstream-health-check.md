---
title: "Proxy upstream health check failed"
description: "Fiber proxy middleware sends requests to a marked-down upstream because the health check goroutine failed to update the status"
frameworks: ['fiber']
...
This error occurs when fiber proxy middleware sends requests to a marked-down upstream because the health check goroutine failed to update the status.
