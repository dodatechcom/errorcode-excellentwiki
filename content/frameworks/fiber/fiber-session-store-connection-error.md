---
title: "Session store connection error"
description: "Fiber session middleware cannot persist session data because the Redis or database session store connection is refused or timed out"
frameworks: ['fiber']
...
This error occurs when fiber session middleware cannot persist session data because the redis or database session store connection is refused or timed out.
