---
title: "WebSocket accept handshake failed"
description: "Fiber WebSocket upgrader rejects the connection because the client does not send the required Upgrade and Connection headers"
frameworks: ['fiber']
...
This error occurs when fiber websocket upgrader rejects the connection because the client does not send the required upgrade and connection headers.
