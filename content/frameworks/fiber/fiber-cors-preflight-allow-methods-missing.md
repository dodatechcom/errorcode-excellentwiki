---
title: "CORS preflight AllowMethods missing"
description: "Fiber CORS preflight response omits the requested HTTP method from Access-Control-Allow-Methods causing the browser to block the actual request"
frameworks: ['fiber']
...
This error occurs when fiber cors preflight response omits the requested http method from access-control-allow-methods causing the browser to block the actual request.
