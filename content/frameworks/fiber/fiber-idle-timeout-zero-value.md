---
title: "Idle timeout zero value"
description: "Fiber server does not close idle keep-alive connections because the IdleTimeout is set to zero causing connection pool exhaustion"
frameworks: ['fiber']
...
This error occurs when fiber server does not close idle keep-alive connections because the idletimeout is set to zero causing connection pool exhaustion.
