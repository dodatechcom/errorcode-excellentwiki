---
title: "Rate limiter expired cleanup"
description: "Fiber in-memory rate limiter does not clean up expired entries causing memory consumption to grow continuously under high traffic"
frameworks: ['fiber']
...
This error occurs when fiber in-memory rate limiter does not clean up expired entries causing memory consumption to grow continuously under high traffic.
