---
title: "Cache-Control no-store missing"
description: "Fiber cache control middleware does not set the no-store directive for sensitive routes allowing intermediate proxies to cache private data"
frameworks: ['fiber']
...
This error occurs when fiber cache control middleware does not set the no-store directive for sensitive routes allowing intermediate proxies to cache private data.
