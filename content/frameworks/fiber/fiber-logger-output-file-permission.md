---
title: "Logger output file permission denied"
description: "Fiber logger middleware cannot write to the specified log file because the process does not have write permission on the target directory"
frameworks: ['fiber']
...
This error occurs when fiber logger middleware cannot write to the specified log file because the process does not have write permission on the target directory.
