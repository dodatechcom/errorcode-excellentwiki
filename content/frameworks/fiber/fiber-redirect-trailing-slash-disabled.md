---
title: "Redirect trailing slash disabled"
description: "Fiber server does not redirect requests with a trailing slash to the canonical path because DisableRedirecting is set to true"
frameworks: ['fiber']
...
This error occurs when fiber server does not redirect requests with a trailing slash to the canonical path because disableredirecting is set to true.
