---
title: "CORS middleware credentials error"
description: "Fiber CORS middleware rejects cross-origin requests with credentials because Access-Control-Allow-Origin is set to wildcard instead of the specific origin"
frameworks: ['fiber']
...
This error occurs when fiber cors middleware rejects cross-origin requests with credentials because access-control-allow-origin is set to wildcard instead of the specific origin.
