---
title: "Idle connections per IPv4 exceeded"
description: "Fiber proxy connection pool keeps too many idle connections to a single upstream causing the upstream to reject new connection attempts"
frameworks: ['fiber']
...
This error occurs when fiber proxy connection pool keeps too many idle connections to a single upstream causing the upstream to reject new connection attempts.
