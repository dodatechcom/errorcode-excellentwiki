---
title: "Proxy rewrite target invalid"
description: "Fiber proxy middleware cannot rewrite the request URL because the target template contains invalid escape sequences or unmatched braces"
frameworks: ['fiber']
...
This error occurs when fiber proxy middleware cannot rewrite the request url because the target template contains invalid escape sequences or unmatched braces.
