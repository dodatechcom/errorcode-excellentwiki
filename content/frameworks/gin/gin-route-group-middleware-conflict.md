---
title: "Route group middleware conflict"
description: "Gin route group applies conflicting middleware that modifies the response writer causing panics when writing headers twice"
frameworks: ['gin']
...
This error occurs when gin route group applies conflicting middleware that modifies the response writer causing panics when writing headers twice.
