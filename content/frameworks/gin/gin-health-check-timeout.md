---
title: "Health check endpoint timeout"
description: "Gin health check handler does not complete within the Kubernetes liveness probe timeout due to blocking database connection check"
frameworks: ['gin']
...
This error occurs when gin health check handler does not complete within the kubernetes liveness probe timeout due to blocking database connection check.
