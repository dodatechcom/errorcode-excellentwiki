---
title: "File upload exceeds max size"
description: "Gin form file upload fails because the multipart form data exceeds the configured MaxMultipartMemory limit"
frameworks: ['gin']
...
This error occurs when gin form file upload fails because the multipart form data exceeds the configured maxmultipartmemory limit.
