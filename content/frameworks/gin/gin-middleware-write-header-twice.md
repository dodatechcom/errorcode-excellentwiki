---
title: "Middleware writes header twice"
description: "Gin middleware attempts to set HTTP status code after the response body has already been written causing a superfluous WriteHeader warning"
frameworks: ['gin']
...
This error occurs when gin middleware attempts to set http status code after the response body has already been written causing a superfluous writeheader warning.
