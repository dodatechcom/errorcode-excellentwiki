---
title: "CORS preflight cache expired"
description: "Gin CORS preflight response does not set Access-Control-Max-Age causing the browser to send a new OPTIONS request for every API call"
frameworks: ['gin']
...
This error occurs when gin cors preflight response does not set access-control-max-age causing the browser to send a new options request for every api call.
