---
title: "ShouldBindURI missing parameter"
description: "Gin ShouldBindURI fails because the route does not define the URI parameter that the binding struct expects to receive"
frameworks: ['gin']
...
This error occurs when gin shouldbinduri fails because the route does not define the uri parameter that the binding struct expects to receive.
