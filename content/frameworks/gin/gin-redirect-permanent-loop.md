---
title: "Permanent redirect causes loop"
description: "Gin RedirectPermanent sends a 301 redirect to a URL that redirects back to the original path creating an infinite loop"
frameworks: ['gin']
...
This error occurs when gin redirectpermanent sends a 301 redirect to a url that redirects back to the original path creating an infinite loop.
