---
title: "CORS credentials cross-origin error"
description: "Gin CORS middleware allows credentials but the Access-Control-Allow-Origin header is set to a wildcard causing the browser to reject the response"
frameworks: ['gin']
...
This error occurs when gin cors middleware allows credentials but the access-control-allow-origin header is set to a wildcard causing the browser to reject the response.
