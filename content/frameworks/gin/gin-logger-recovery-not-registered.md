---
title: "Logger and recovery middleware not registered"
description: "Gin engine runs without gin.Logger and gin.Recovery middleware causing unhandled panics to crash the server process"
frameworks: ['gin']
...
This error occurs when gin engine runs without gin.logger and gin.recovery middleware causing unhandled panics to crash the server process.
