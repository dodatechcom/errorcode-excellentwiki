---
title: "Route registration order issue"
description: "Gin routes registered after the catch-all route never match because the catch-all captures all remaining path patterns"
frameworks: ['gin']
...
This error occurs when gin routes registered after the catch-all route never match because the catch-all captures all remaining path patterns.
