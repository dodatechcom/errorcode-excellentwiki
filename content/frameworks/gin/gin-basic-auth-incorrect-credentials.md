---
title: "Basic auth incorrect credentials"
description: "Gin BasicAuth middleware rejects all login attempts because the accounts map contains incorrect username or password values"
frameworks: ['gin']
...
This error occurs when gin basicauth middleware rejects all login attempts because the accounts map contains incorrect username or password values.
