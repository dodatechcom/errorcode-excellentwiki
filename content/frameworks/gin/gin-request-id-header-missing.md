---
title: "Request ID header missing"
description: "Gin request ID middleware does not propagate the X-Request-ID header because the upstream proxy strips unknown headers"
frameworks: ['gin']
...
This error occurs when gin request id middleware does not propagate the x-request-id header because the upstream proxy strips unknown headers.
