---
title: "Config reload at runtime fails"
description: "Gin server attempts to hot-reload configuration but the new config file has a parse error causing the reload to fail silently"
frameworks: ['gin']
...
This error occurs when gin server attempts to hot-reload configuration but the new config file has a parse error causing the reload to fail silently.
