---
title: "Test handler no response written"
description: "Gin unit test does not call any Write method on the context causing httptest.ResponseRecorder to return a 200 with empty body"
frameworks: ['gin']
...
This error occurs when gin unit test does not call any write method on the context causing httptest.responserecorder to return a 200 with empty body.
