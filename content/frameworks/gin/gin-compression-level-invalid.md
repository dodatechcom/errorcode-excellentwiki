---
title: "Compression level invalid"
description: "Gin gzip middleware returns an error because the configured compression level exceeds the valid range for the zlib encoder"
frameworks: ['gin']
...
This error occurs when gin gzip middleware returns an error because the configured compression level exceeds the valid range for the zlib encoder.
