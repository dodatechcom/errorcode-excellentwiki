---
title: "Internal server error details leaked"
description: "Gin default error handler exposes raw Go error messages in the HTTP response body revealing internal implementation details"
frameworks: ['gin']
...
This error occurs when gin default error handler exposes raw go error messages in the http response body revealing internal implementation details.
