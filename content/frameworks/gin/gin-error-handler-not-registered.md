---
title: "Custom error handler not registered"
description: "Gin engine uses the default error handler which returns generic 500 responses instead of the application-specific error format"
frameworks: ['gin']
...
This error occurs when gin engine uses the default error handler which returns generic 500 responses instead of the application-specific error format.
