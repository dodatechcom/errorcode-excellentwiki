---
title: "Route path trailing slash mismatch"
description: "Gin route defined with a trailing slash does not match incoming requests without the slash due to RedirectTrailingSlash being disabled"
frameworks: ['gin']
...
This error occurs when gin route defined with a trailing slash does not match incoming requests without the slash due to redirecttrailingslash being disabled.
