---
title: "Request timeout not enforced"
description: "Gin handlers do not respect context timeout because the http.Request context is not propagated to downstream database or API calls"
frameworks: ['gin']
...
This error occurs when gin handlers do not respect context timeout because the http.request context is not propagated to downstream database or api calls.
