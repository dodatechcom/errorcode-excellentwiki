---
title: "Context values lost after Next"
description: "Gin middleware sets values on the context that are lost because the handler chain continues with a copied context object"
frameworks: ['gin']
...
This error occurs when gin middleware sets values on the context that are lost because the handler chain continues with a copied context object.
