---
title: "Negotiate content type not accepted"
description: "Gin context.Negotiate returns an error because the client Accept header does not match any of the offered serialization formats"
frameworks: ['gin']
...
This error occurs when gin context.negotiate returns an error because the client accept header does not match any of the offered serialization formats.
