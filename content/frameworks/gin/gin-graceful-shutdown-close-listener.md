---
title: "Graceful shutdown close listener error"
description: "Gin server close listener returns an error during shutdown because a connected client is holding the socket open indefinitely"
frameworks: ['gin']
...
This error occurs when gin server close listener returns an error during shutdown because a connected client is holding the socket open indefinitely.
