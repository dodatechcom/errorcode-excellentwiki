---
title: "JSON binding malformed request body"
description: "Gin ShouldBindJSON fails to parse the incoming request body because it contains invalid JSON syntax or unexpected field types"
frameworks: ['gin']
...
This error occurs when gin shouldbindjson fails to parse the incoming request body because it contains invalid json syntax or unexpected field types.
