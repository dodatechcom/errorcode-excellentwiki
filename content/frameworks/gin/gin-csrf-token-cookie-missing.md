---
title: "CSRF token cookie missing"
description: "Gin CSRF protection middleware rejects the form submission because the browser did not send the required CSRF token cookie"
frameworks: ['gin']
...
This error occurs when gin csrf protection middleware rejects the form submission because the browser did not send the required csrf token cookie.
