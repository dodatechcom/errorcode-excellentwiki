---
title: "CORS middleware preflight failure"
description: "Gin CORS middleware rejects OPTIONS preflight requests because the allowed methods or headers are not configured for the frontend origin"
frameworks: ['gin']
...
This error occurs when gin cors middleware rejects options preflight requests because the allowed methods or headers are not configured for the frontend origin.
