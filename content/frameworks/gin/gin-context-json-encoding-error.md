---
title: "Context JSON encoding error"
description: "Gin ctx.JSON serializes a response that contains a channel or func field causing json.Marshal to return an unsupported type error"
frameworks: ['gin']
...
This error occurs when gin ctx.json serializes a response that contains a channel or func field causing json.marshal to return an unsupported type error.
