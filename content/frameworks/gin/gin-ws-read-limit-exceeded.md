---
title: "WebSocket read limit exceeded"
description: "Gin WebSocket handler panics because the incoming message size exceeds the configured ReadLimit causing a read buffer overflow"
frameworks: ['gin']
...
This error occurs when gin websocket handler panics because the incoming message size exceeds the configured readlimit causing a read buffer overflow.
