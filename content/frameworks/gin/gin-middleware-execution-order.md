---
title: "Middleware execution order incorrect"
description: "Gin middleware chain executes in the wrong order causing authentication checks to run after the protected handler has already responded"
frameworks: ['gin']
...
This error occurs when gin middleware chain executes in the wrong order causing authentication checks to run after the protected handler has already responded.
