...
description: "Gin HTTP handler exhausts the database connection pool because connections are not released after use in the request lifecycle"
frameworks: ['gin']
...
This error occurs when gin http handler exhausts the database connection pool because connections are not released after use in the request lifecycle.
