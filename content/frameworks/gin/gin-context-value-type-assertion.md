---
title: "Context value type assertion panic"
description: "Gin handler retrieves a context value but the type assertion fails with a panic because the value was stored as a different type"
frameworks: ['gin']
...
This error occurs when gin handler retrieves a context value but the type assertion fails with a panic because the value was stored as a different type.
