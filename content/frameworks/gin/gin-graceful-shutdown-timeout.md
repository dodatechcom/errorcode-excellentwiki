---
title: "Graceful shutdown timeout exceeded"
description: "Gin server does not complete in-flight requests before the context deadline during graceful shutdown causing dropped connections"
frameworks: ['gin']
...
This error occurs when gin server does not complete in-flight requests before the context deadline during graceful shutdown causing dropped connections.
