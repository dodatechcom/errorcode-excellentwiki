---
title: "Trusted proxy configuration missing"
description: "Gin engine reads incorrect client IP addresses because trusted proxies are not configured in a load-balanced deployment"
frameworks: ['gin']
...
This error occurs when gin engine reads incorrect client ip addresses because trusted proxies are not configured in a load-balanced deployment.
