---
title: "Request body already consumed"
description: "Gin handler calls io.ReadAll on the request body before ShouldBindJSON causing the binding to read an empty stream"
frameworks: ['gin']
...
This error occurs when gin handler calls io.readall on the request body before shouldbindjson causing the binding to read an empty stream.
