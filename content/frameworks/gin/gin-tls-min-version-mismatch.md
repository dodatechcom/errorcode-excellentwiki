---
title: "TLS minimum version mismatch"
description: "Gin TLS server configuration specifies a TLS version that is not supported by the Go crypto/tls package or the client browser"
frameworks: ['gin']
...
This error occurs when gin tls server configuration specifies a tls version that is not supported by the go crypto/tls package or the client browser.
