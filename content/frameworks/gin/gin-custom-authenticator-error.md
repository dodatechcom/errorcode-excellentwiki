---
title: "Custom authenticator middleware error"
description: "Gin custom authentication middleware returns an error response but the handler still executes due to missing return statement"
frameworks: ['gin']
...
This error occurs when gin custom authentication middleware returns an error response but the handler still executes due to missing return statement.
