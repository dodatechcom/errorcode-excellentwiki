---
title: "Route wildcard pattern shadows"
description: "Gin wildcard route parameter captures the entire remaining path segment causing specific routes defined after the wildcard to never match"
frameworks: ['gin']
...
This error occurs when gin wildcard route parameter captures the entire remaining path segment causing specific routes defined after the wildcard to never match.
